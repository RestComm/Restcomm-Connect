...
public final class SmsInterpreter extends UntypedActor {
  ...
  public SmsInterpreter(final ActorRef service, final Configuration configuration,
      final DaoManager storage, final Sid accountId, final String version,
      final URI url, final String method, final URI fallbackUrl,
      final String fallbackMethod) {
    super();
    final ActorRef source = self();
    uninitialized = new State("uninitialized", null, null);
    acquiringLastSmsRequest = new State("acquiring last sms event",
    ...
    waitingForSmsResponses = new State("waiting for sms responses",
        new WaitingForSmsResponses(source), null);
