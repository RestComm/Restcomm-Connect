...
@Immutable public class Tag {
  ...
  private Tag(final String name, final Tag parent, final String text,
      final Map<String, Attribute> attributes, final List<Tag> children,
