...
public class DialUrlVerbTest extends AbstractTest {
	...
	private static String appName = "dialtestURL-app.xml";
	...
	public void setUp() throws Exception
	{
		...
		sipPhoneSender = sender.createSipPhone("127.0.0.1", SipStack.PROTOCOL_UDP, 5070, "sip:sender@here.com");
		...
		sipPhoneReceiver = receiver.createSipPhone("127.0.0.1", SipStack.PROTOCOL_UDP, 5070, "sip:+16000@here.com");
	...
	@Test 
	public void dialNumberWithURLTest() throws ParseException, TwilioRestException, ClassNotFoundException{	
...
//		List<String> events = ((EmbeddedMediaserverImpl)mediaserver).getListener().getAllReceivedRequests();
