var app = angular.module('restcomm', ['ngRoute', 'ngResource', 'ui.bootstrap', 'angular-md5', 'loadingOnAJAX']).
    config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        $routeProvider.
            ...
            when('/numbers/incoming/:phoneSid', {templateUrl: 'modules/numbers-incoming-details.html', controller: NumberDetailsCtrl}).
            when('/numbers/clients', {templateUrl: 'modules/numbers-clients.html', controller: ClientsCtrl}).
            when('/numbers/clients/:clientSid', {templateUrl: 'modules/numbers-clients-details.html', controller: ClientsDetailsCtrl}).
            ...
            when('/logs/calls/:callSid', {templateUrl: 'modules/logs-calls-details.html', controller: LogsCallsDetailsCtrl}).
...
app.service("AuthService", function($http, $location, SessionService, md5) {
    var cacheSession   = function(account) {
        SessionService.set('authenticated', true);
        SessionService.set('sid', account.sid);
        SessionService.set('logged_user', account.friendly_name);
    };
