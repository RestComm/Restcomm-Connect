...
public final class ConferenceDetailRecord {
    ...
    public ConferenceDetailRecord(final Sid sid, final DateTime dateCreated, final DateTime dateUpdated, final Sid accountSid,
            ...
            final String masterConfernceEndpointId, final boolean isMasterPresent, final String masterIVREndpointId,
            final String masterIVREndpointSessionId, final String masterBridgeEndpointId,
            final String masterBridgeEndpointSessionId, final String masterBridgeConnectionIdentifier,
    ...
    public ConferenceDetailRecord setStatus(final String status) {
        return new ConferenceDetailRecord(sid, dateCreated, DateTime.now(), accountSid, status, friendlyName, apiVersion, uri,
                masterMsId, masterConfernceEndpointId, masterPresent, masterIVREndpointId, masterIVREndpointSessionId,
    ...
    public static final class Builder {
        ...
        public ConferenceDetailRecord build() {
            return new ConferenceDetailRecord(sid, dateCreated, DateTime.now(), accountSid, status, friendlyName, apiVersion,
                    uri, masterMsId, masterConfernceEndpointId, isMasterPresent, masterIVREndpointId, null, null, null, null,
                    null, false);
        }
    ...
    public String toString() {
        return "ConferenceDetailRecord [sid=" + sid + ", dateCreated=" + dateCreated + ", dateUpdated=" + dateUpdated
                + ", accountSid=" + accountSid + ", status=" + status + ", friendlyName=" + friendlyName + ", apiVersion="
                + apiVersion + ", uri=" + uri + ", masterMsId=" + masterMsId + ", masterPresent=" + masterPresent
                + ", masterConfernceEndpointId=" + masterConfernceEndpointId + ", masterIVREndpointId=" + masterIVREndpointId
                + ", masterIVREndpointSessionId=" + masterIVREndpointSessionId + ", masterBridgeEndpointId="
                + masterBridgeEndpointId + ", masterBridgeEndpointSessionId=" + masterBridgeEndpointSessionId
                + ", masterBridgeConnectionIdentifier=" + masterBridgeConnectionIdentifier + ", masterIVRConnectionIdentifier="
