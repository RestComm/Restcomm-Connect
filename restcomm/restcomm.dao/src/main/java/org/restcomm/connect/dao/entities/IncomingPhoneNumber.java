...
public final class IncomingPhoneNumber {
    ...
    public IncomingPhoneNumber(final Sid sid, final DateTime dateCreated, final DateTime dateUpdated, final String friendlyName,
            final Sid accountSid, final String phoneNumber, final String cost, final String apiVersion,
            ...
            final String smsFallbackMethod, final Sid smsApplicationSid, final URI uri, final URI ussdUrl,
            final String ussdMethod, final URI ussdFallbackUrl, final String ussdFallbackMethod, final Sid ussdApplicationSid,
        ...
        this(sid, dateCreated, dateUpdated, friendlyName, accountSid, phoneNumber, cost, apiVersion, hasVoiceCallerIdLookup,
                ...
                voiceApplicationSid, smsUrl, smsMethod, smsFallbackUrl, smsFallbackMethod, smsApplicationSid, uri, ussdUrl,
                ussdMethod, ussdFallbackUrl, ussdFallbackMethod, ussdApplicationSid, referUrl, referMethod, referApplicationSid,
    ...
    public IncomingPhoneNumber(final Sid sid, final DateTime dateCreated, final DateTime dateUpdated, final String friendlyName,
            ...
            final String smsFallbackMethod, final Sid smsApplicationSid, final URI uri, final URI ussdUrl,
            final String ussdMethod, final URI ussdFallbackUrl, final String ussdFallbackMethod, final Sid ussdApplicationSid,
            final URI referUrl, final String referMethod, final Sid referApplicationSid, final Boolean voiceCapable,
    ...
    public IncomingPhoneNumber(final Sid sid, final DateTime dateCreated, final DateTime dateUpdated, final String friendlyName,
            ...
            final URI referUrl, final String referMethod, final Sid referApplicationSid, final Boolean voiceCapable,
            final Boolean smsCapable, final Boolean mmsCapable, final Boolean faxCapable, final Boolean pureSip,
            final String voiceApplicationName, final String smsApplicationName, final String ussdApplicationName,
            final String referApplicationName) {
        super();
        this.sid = sid;
    ...
    public static final class Builder {
        ...
        public IncomingPhoneNumber build() {
            ...
            return new IncomingPhoneNumber(sid, now, now, friendlyName, accountSid, phoneNumber, cost, apiVersion,
                    ...
                    referUrl, referMethod, referApplicationSid, voiceCapable, smsCapable, mmsCapable, faxCapable, pureSip);
        }
