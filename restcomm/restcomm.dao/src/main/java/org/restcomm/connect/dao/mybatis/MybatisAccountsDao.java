...
public final class MybatisAccountsDao implements AccountsDao {
    ...
    public List<String> getAccountLineage(Sid accountSid) throws AccountHierarchyDepthCrossed {
        ...
        if (account == null)
            throw new IllegalArgumentException(
                    "Wrong accountSid is given to search for ancestor on it. This account does not even exist");
        ...
        while (true) {
            ...
            if (parentSid != null) {
                ...
                if (parentAccount == null)
                    throw new IllegalStateException("Parent account " + parentSid.toString()
                            + " does not exist although its child does " + account.getSid().toString());
    ...
    private Account toAccount(final Map<String, Object> map) {
        ...
        return new Account(sid, dateCreated, dateUpdated, emailAddress, friendlyName, parentSid, type, status, authToken, role,
                uri);
    }
