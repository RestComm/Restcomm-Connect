...
public interface ExtensionsConfigurationDao {
     ...
     * @param accountSid
     */
    void addAccountExtensionConfiguration(ExtensionConfiguration extensionConfiguration, Sid accountSid)
     ...
     * @param accountSid
     */
    void updateAccountExtensionConfiguration(ExtensionConfiguration extensionConfiguration, Sid accountSid)
            throws ConfigurationException;
