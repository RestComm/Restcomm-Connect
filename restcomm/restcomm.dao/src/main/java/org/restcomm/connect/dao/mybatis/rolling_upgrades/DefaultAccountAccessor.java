...
import static org.restcomm.connect.dao.DaoUtils.readAccountPasswordAlgorithm;
...
import static org.restcomm.connect.dao.DaoUtils.writeAccountPasswordAlgorithm;
 ...
 */
public class DefaultAccountAccessor implements AccountAccessor {
    ...
    public Account toAccount(final Map<String, Object> map) {
        ...
        final Account.PasswordAlgorithm passwordAlgorithm = readAccountPasswordAlgorithm(map.get("password_algorithm"));
    ...
    public Map<String, Object> toMap(final Account account) {
        ...
        map.put("password_algorithm", writeAccountPasswordAlgorithm(account.getPasswordAlgorithm()));
