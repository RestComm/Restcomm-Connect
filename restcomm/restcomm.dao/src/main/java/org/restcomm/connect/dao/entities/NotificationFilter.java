...
public class NotificationFilter {
    ...
    public NotificationFilter(String accountSid, List<String> accountSidSet, String startTime, String endTime, String errorCode,
            String requestUrl, String messageText, Integer limit, Integer offset) throws ParseException {
        this(accountSid, accountSidSet, startTime, endTime, errorCode, requestUrl, messageText, limit, offset, null);
    }

    public NotificationFilter(String accountSid, List<String> accountSidSet, String startTime, String endTime, String errorCode,
            String requestUrl, String messageText, Integer limit, Integer offset, String instanceId) throws ParseException {
