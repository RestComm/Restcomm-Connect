...
public final class MybatisTranscriptionsDao implements TranscriptionsDao {
    ...
    public List<Transcription> getTranscriptions(final Sid accountSid) {
        final SqlSession session = sessions.openSession();
        try {
            final List<Map<String, Object>> results = session.selectList(namespace + "getTranscriptions",
                    accountSid.toString());
    ...
    public List<Transcription> getTranscriptions(TranscriptionFilter filter) {
        ...
        try {
            final List<Map<String, Object>> results = session.selectList(namespace + "getTranscriptionsByUsingFilters", filter);
