...
public final class MybatisRecordingsDao implements RecordingsDao {
    ...
    public List<Recording> getRecordings(RecordingFilter filter) {
        ...
        try {
            final List<Map<String, Object>> results = session.selectList(namespace + "getRecordingsByUsingFilters", filter);
    ...
    private Recording toRecording(final Map<String, Object> map) {
        ...
        // For backward compatibility. For old an database that we upgraded to the latest schema, the file_uri will be null so
        // we need
        ...
        // fileUri:
        // http://192.168.1.190:8080/restcomm/2012-04-24/Accounts/ACae6e420f425248d6a26948c17a9e2acf/Recordings/RE4c9c09908b60402c8c0a77e24313f27d.wav
        // s3Uri: https://gvagrestcomm.s3.amazonaws.com/RE4c9c09908b60402c8c0a77e24313f27d.wav
        // old S3URI:
        // https://s3.amazonaws.com/restcomm-as-a-service/logs/RE7ddbd5b441574e4ab786a1fddf33eb47.wav?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20170209T103950Z&X-Amz-SignedHeaders=host&X-Amz-Expires=604800&X-Amz-Credential=AKIAIRG5NINXKJAJM5DA%2F20170209%2Fus-east-1%2Fs3%2Faws4_request&X-Amz-Signature=b3da2acc17ee9c6aca4cd151e154d94f530670850f0fcade2422f85d1c7cc992
        ...
        recording = new Recording(sid, dateCreated, dateUpdated, accountSid, callSid, duration, apiVersion, uri,
                DaoUtils.readUri(fileUri), DaoUtils.readUri(s3Uri));
        if (update) {
