...
public class ExtensionConfigurationDaoTest {
    ...
    public void testValidJsonDoc() {
        ExtensionConfiguration validExtensionConfiguration = new ExtensionConfiguration(
                Sid.generate(Sid.Type.EXTENSION_CONFIGURATION), "testExt", true, validJsonObject,
    ...
    public void testInvalidJsonDoc() {
        ExtensionConfiguration invalidExtensionConfiguration = new ExtensionConfiguration(
                Sid.generate(Sid.Type.EXTENSION_CONFIGURATION), "testExt", true, invalidJsonObject,
                ExtensionConfiguration.configurationType.JSON, DateTime.now());
    ...
    public void testValidXmlDoc() {
        ExtensionConfiguration validExtensionConfiguration = new ExtensionConfiguration(
                Sid.generate(Sid.Type.EXTENSION_CONFIGURATION), "testExt", true, validXmlDoc,
                ExtensionConfiguration.configurationType.XML, DateTime.now());
        assertEquals(true, extensionsConfigurationDao.validate(validExtensionConfiguration));
    }
    ...
    public void testInvalidXmlDoc() {
        ExtensionConfiguration invalidExtensionConfiguration = new ExtensionConfiguration(
                Sid.generate(Sid.Type.EXTENSION_CONFIGURATION), "testExt", true, invalidXmlDoc,
                ExtensionConfiguration.configurationType.XML, DateTime.now());
        assertEquals(false, extensionsConfigurationDao.validate(invalidExtensionConfiguration));
    }
    ...
    public void testStoreAndRetrieveConfigurationByNameJson() throws ConfigurationException {
        ...
        ExtensionConfiguration validExtensionConfiguration = new ExtensionConfiguration(
                Sid.generate(Sid.Type.EXTENSION_CONFIGURATION), extName, true, validJsonObject,
                ExtensionConfiguration.configurationType.JSON, DateTime.now());
        ...
        assertEquals(retrievedConf.getConfigurationData().toString(),
                validExtensionConfiguration.getConfigurationData().toString());
    ...
    public void testStoreAndRetrieveConfigurationBySidJson() throws ConfigurationException {
        ...
        ExtensionConfiguration validExtensionConfiguration = new ExtensionConfiguration(sid, "testExt", true, validJsonObject,
                ExtensionConfiguration.configurationType.JSON, DateTime.now());
        extensionsConfigurationDao.addConfiguration(validExtensionConfiguration);
    ...
    public void testStoreAndRetrieveConfigurationByNameXml() throws ConfigurationException {
        String extName = "testExt";
        ExtensionConfiguration validExtensionConfiguration = new ExtensionConfiguration(
                Sid.generate(Sid.Type.EXTENSION_CONFIGURATION), extName, true, validXmlDoc,
                ExtensionConfiguration.configurationType.XML, DateTime.now());
        extensionsConfigurationDao.addConfiguration(validExtensionConfiguration);
        ExtensionConfiguration retrievedConf = extensionsConfigurationDao.getConfigurationByName(extName);
        assertNotNull(retrievedConf);
    ...
    public void testStoreAndRetrieveConfigurationBySidXml() throws ConfigurationException {
        Sid sid = Sid.generate(Sid.Type.EXTENSION_CONFIGURATION);
        ExtensionConfiguration validExtensionConfiguration = new ExtensionConfiguration(sid, "testExt", true, validXmlDoc,
                ExtensionConfiguration.configurationType.XML, DateTime.now());
        extensionsConfigurationDao.addConfiguration(validExtensionConfiguration);
        ExtensionConfiguration retrievedConf = extensionsConfigurationDao.getConfigurationBySid(sid);
        assertNotNull(retrievedConf);
    ...
    public void testStoreAndGetAllConfiguration() throws ConfigurationException {
        ...
        ExtensionConfiguration validExtensionConfigurationXml = new ExtensionConfiguration(sid1, "testExtXml", true,
                validXmlDoc, ExtensionConfiguration.configurationType.XML, DateTime.now());
        ExtensionConfiguration validExtensionConfigurationJson = new ExtensionConfiguration(sid2, "testExtJson", true,
                validJsonObject, ExtensionConfiguration.configurationType.JSON, DateTime.now());
    ...
    public void testStoreUpdateAndRetrieveConfigurationByNameCheckVersionJson() throws ConfigurationException {
        String extName = "testExt";
        ExtensionConfiguration originalExtensionConfiguration = new ExtensionConfiguration(
                Sid.generate(Sid.Type.EXTENSION_CONFIGURATION), extName, true, validJsonObject,
                ExtensionConfiguration.configurationType.JSON, DateTime.now());
        ...
        assertNotNull(retrievedConf);
        assertEquals(retrievedConf.getConfigurationData().toString(),
                originalExtensionConfiguration.getConfigurationData().toString());
    ...
    public void testStoreUpdateAndRetrieveConfigurationBySidCheckVersionJson() throws ConfigurationException {
        String extName = "testExt";
        Sid sid = Sid.generate(Sid.Type.EXTENSION_CONFIGURATION);
        ExtensionConfiguration originalExtensionConfiguration = new ExtensionConfiguration(sid, extName, true, validJsonObject,
                ExtensionConfiguration.configurationType.JSON, DateTime.now());
        extensionsConfigurationDao.addConfiguration(originalExtensionConfiguration);
