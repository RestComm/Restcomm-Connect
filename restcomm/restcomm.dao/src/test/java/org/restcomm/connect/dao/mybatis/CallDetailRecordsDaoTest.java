...
public class CallDetailRecordsDaoTest extends DaoTest {
    ...
    public void retrieveAccountCdrsRecursively() throws ParseException {
         ...
         * Sample data summary
         *
         * 100 calls in total 12 calls belong to AC00000000000000000000000000000000 5 calls belong to
         * AC11111111111111111111111111111111 8 calls belong to AC22222222222222222222222222222222
         */
        ...
        CallDetailRecordFilter filter = new CallDetailRecordFilter(null, accountSidSet, null, null, null, null, null, null,
                null, null, null);
        ...
        filter = new CallDetailRecordFilter("ACae6e420f425248d6a26948c17a9e2acf", accountSidSet, null, null, null, null, null,
                null, null, null, null);
        accountSidSet.add("AC00000000000000000000000000000000");
        accountSidSet.add("AC11111111111111111111111111111111");
        accountSidSet.add("AC22222222222222222222222222222222");
        ...
        filter = new CallDetailRecordFilter("AC00000000000000000000000000000000", null, null, null, null, null, null, null,
                null, null, null);
        Assert.assertEquals(12, dao.getTotalCallDetailRecords(filter).intValue());
    }
}
