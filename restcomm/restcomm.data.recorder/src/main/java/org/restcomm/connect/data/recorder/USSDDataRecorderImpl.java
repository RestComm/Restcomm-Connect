...
import org.restcomm.connect.data.recorder.api.interfaces.USSDDataRecorder;
 ...
 */
@Immutable
public final class USSDDataRecorderImpl extends UntypedActor implements USSDDataRecorder{
    ...
    public USSDDataRecorderImpl(final DaoManager daoManager) {
        super();
