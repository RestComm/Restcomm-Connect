...
public final class UssdInterpreterParams {
    ...
    private UssdInterpreterParams(Configuration configuration, DaoManager storage, ActorRef callManager, ActorRef sms,
            Sid account, Sid phone, String version, URI url, String method, URI fallbackUrl, String fallbackMethod,
            URI statusCallback, String statusCallbackMethod, String emailAddress) {
    ...
    public static final class Builder {
        ...
        public UssdInterpreterParams build() {
            return new UssdInterpreterParams(configuration, storage, callManager, sms, account, phone, version, url, method,
