...
public class UssdCall extends RestcommUntypedActor {
    ...
    private SipURI getInitialIpAddressPort(SipServletMessage message) throws ServletParseException, UnknownHostException {
        ...
        // logger.info("RemotePort: "+remotePort+" is different than the Contact Address port: "+contactPort+" so storing for
        // later use the "
    ...
    public void onReceive(final Object message) throws Exception {
        ...
        if (Observe.class.equals(klass)) {
            ...
            if (response.getStatus() == SipServletResponse.SC_OK
                    && (response.getRequest().getMethod().equalsIgnoreCase("BYE"))) {
