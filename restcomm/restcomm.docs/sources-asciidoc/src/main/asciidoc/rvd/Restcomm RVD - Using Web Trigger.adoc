...
Supply the credentials of the Restcomm account that will be used to create the call. You can find them in the Administration Console dashboard.

* Set *Username* to _administrator@company.com_
* Set *Auth Token* to the account AuthToken copid from Restcomm Console dashboard

_* As of Restcomm 8.0.0 *Password* is no more accepted and *Auth Token* is required for security reasons_.
...
Headers
  ...
  Authorization: Basic YWRtaW5pc3RyYXRvckBjb21wYW55LmNvbTo3N2Y4YzEyY2M3YjhmODQyM2U1YzM4YjAzNTI0OTE2
                       Ng==
