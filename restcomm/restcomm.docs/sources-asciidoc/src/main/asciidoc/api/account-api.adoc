...
|OrganizationSid |A string that uniquely identifies the Organization that this Account belongs to.
|=========================================================================================================================
...
|OrganizationSid |A valid Organization identifier (SID)
|==============================================================================================

(Note: If the OrganizationSid is informed, all the sub accounts related to this Account will have their OrganizationSid attribute updated as well.)
...
<RestcommResponse>
  <Account>
    ...
    <OrganizationSid>ORec3515ebea5243b6bde0444d84b05b80</OrganizationSid>
  </Account>
----
