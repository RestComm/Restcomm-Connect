...
image:images/RestComm_UMTS_Notification_Geolocation.png[image,width=633,height=230]
...
image:images/RestComm_LTE_Notification_Geolocation.png[image,width=633,height=230]
