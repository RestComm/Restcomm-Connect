...
image:images/RestComm_UMTS_Notification_Geolocation.png[image,width=900,height=675]
...
image:images/RestComm_LTE_Notification_Geolocation.png[image,width=900,height=675]
