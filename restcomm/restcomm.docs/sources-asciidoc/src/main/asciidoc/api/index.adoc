...
as _password_. There are few exceptions to this rule where the account `Password` is used for more critical operations.
Such exceptions will be pointed out in their individual documentation section.
