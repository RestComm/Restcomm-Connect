...
<RestcommResponse>
  <Application>
    ...
    <RcmlUrl>http://127.0.0.1:8080/visual-designer/services/apps/foobar/controller</RcmlUrl>
    <Kind>voice</Kind>
  </Application>
</RestcommResponse>
----
