...
* OSX seems to have known for mount denied issue on `/var/log/restcomm` directory, in such mount logs with any directory under `/Users` directory here is an example
