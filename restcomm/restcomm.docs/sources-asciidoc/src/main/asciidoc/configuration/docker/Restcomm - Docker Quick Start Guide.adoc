...
* Tags "7.6.0" or "7.5.0" etc, are pointing to a specific GA release. For example:  restcomm/restcomm:7.6.0 restcomm/restcomm:7.5.0 etc.
...
6.  You can also make a calll to the "**+123**5" to test your Text-to-Speech configuration
