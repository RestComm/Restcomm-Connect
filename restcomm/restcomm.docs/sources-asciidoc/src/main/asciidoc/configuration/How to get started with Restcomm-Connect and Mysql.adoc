...
[source,bash]
----
 mysql -u root < $RESTCOMM_HOME/standalone/deployments/restcomm.war/WEB-INF/scripts/mariadb/init.sql
----
...
ALTER USER PRIVILEGES ON *.* TO 'root'@'192.168.1.%' IDENTIFIED BY 'V!rg1nMySql' WITH GRANT OPTION;
----
