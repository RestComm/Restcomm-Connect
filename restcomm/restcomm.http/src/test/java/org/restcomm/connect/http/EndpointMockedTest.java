...
public class EndpointMockedTest {
    ...
    void init() {
        ...
        accounts.add(new Account(new Sid("AC00000000000000000000000000000000"),null,null,"administrator@company.com","Administrator",null,null,null, "RestComm", "77f8c12cc7b8f8423e5c38b035249166",null,null));
