 ...
 *
 * - Configuration - DaoManager and individual daos - ServletContext - HttpServletRequest
 *
 * Extend this class and further customize it to test other endpoints. See sample AccountsEndpointMockedTest to get an idea how
 * this works.
 *
...
public class EndpointMockedTest {
    ...
    void init() {
        ...
        accounts.add(new Account(new Sid("AC00000000000000000000000000000000"), null, null, "administrator@company.com",
                "Administrator", null, null, null, "77f8c12cc7b8f8423e5c38b035249166", null, null));
        ...
        when(request.getHeader("Authorization"))
                .thenReturn("Basic YWRtaW5pc3RyYXRvckBjb21wYW55LmNvbTo3N2Y4YzEyY2M3YjhmODQyM2U1YzM4YjAzNTI0OTE2Ng==");
    }
