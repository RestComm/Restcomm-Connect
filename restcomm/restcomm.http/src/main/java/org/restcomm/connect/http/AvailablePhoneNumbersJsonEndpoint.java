...
public class AvailablePhoneNumbersJsonEndpoint extends AvailablePhoneNumbersEndpoint {
    ...
    public Response getAvailablePhoneNumber(@PathParam("accountSid") final String accountSid,
            ...
            @QueryParam("NearNumber") String nearNumber, @QueryParam("NearLatLong") String nearLatLong,
            @QueryParam("Distance") String distance, @QueryParam("InPostalCode") String inPostalCode,
            @QueryParam("InRegion") String inRegion, @QueryParam("InRateCenter") String inRateCenter,
            @QueryParam("InLata") String inLata, @QueryParam("RangeSize") String rangeSize,
        ...
        if (isoCountryCode != null && !isoCountryCode.isEmpty()) {
            ...
            PhoneNumberSearchFilters listFilters = new PhoneNumberSearchFilters(areaCode, null, smsEnabledBool, mmsEnabledBool,
                    voiceEnabledBool, faxEnabledBool, ussdEnabledBool, nearNumber, nearLatLong, distance, inPostalCode,
                    inRegion, inRateCenter, inLata, rangeSizeInt, rangeIndexInt, phoneNumberType);
            return getAvailablePhoneNumbers(accountSid, isoCountryCode, listFilters, filterPattern,
