...
public class ExtensionsConfigurationEndpoint extends SecuredEndpoint {
    ...
    public ExtensionsConfigurationEndpoint() {
        super();
    }
    ...
    protected Response getConfiguration(final String extensionId, final Sid accountSid, final MediaType responseType) {
        ...
        if (accountSid != null) {
            ...
            try {
                extensionAccountConfiguration = extensionsConfigurationDao
                        .getAccountExtensionConfiguration(accountSid.toString(), extensionSid.toString());
                extensionConfiguration.setConfigurationData(extensionAccountConfiguration.getConfigurationData(),
                        extensionAccountConfiguration.getConfigurationType());
            } catch (Exception e) {
                return status(NOT_FOUND).build();
            }
        }
    ...
    private ExtensionConfiguration createFrom(final MultivaluedMap<String, String> data, final MediaType responseType) {
        ...
        ExtensionConfiguration extensionConfiguration = new ExtensionConfiguration(sid, extension, enabled, configurationData,
                configurationType, dateCreated, dateUpdated);
    ...
    private ExtensionConfiguration prepareUpdatedConfiguration(ExtensionConfiguration existingExtensionConfiguration,
            MultivaluedMap<String, String> data, MediaType responseType) {
        validate(data);
        ...
        return new ExtensionConfiguration(existingExtensionSid, existingExtensionName, enabled, configurationData,
                configurationType, dateCreated, DateTime.now());
    }
}
