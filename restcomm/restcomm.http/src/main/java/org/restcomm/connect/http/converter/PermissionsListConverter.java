...
@ThreadSafe
public final class PermissionsListConverter extends AbstractConverter implements JsonSerializer<Permission> {
    private final String apiVersion;
    private final String rootUri;

    public PermissionsListConverter(final Configuration configuration) {
        super(configuration);
