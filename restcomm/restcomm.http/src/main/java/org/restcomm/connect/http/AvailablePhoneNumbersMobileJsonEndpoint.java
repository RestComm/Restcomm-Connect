...
@ThreadSafe
public class AvailablePhoneNumbersMobileJsonEndpoint extends AvailablePhoneNumbersEndpoint {
    public AvailablePhoneNumbersMobileJsonEndpoint() {
        super();
    }
    ...
    public Response getAvailablePhoneNumber(@PathParam("accountSid") final String accountSid,
        ...
        if (isoCountryCode != null && !isoCountryCode.isEmpty()) {
            ...
            PhoneNumberSearchFilters listFilters = new PhoneNumberSearchFilters(areaCode, null, smsEnabledBool, mmsEnabledBool,
                    voiceEnabledBool, faxEnabledBool, ussdEnabledBool, null, null, null, null, null, null, null, rangeSizeInt,
                    rangeIndexInt, PhoneNumberType.Mobile);
