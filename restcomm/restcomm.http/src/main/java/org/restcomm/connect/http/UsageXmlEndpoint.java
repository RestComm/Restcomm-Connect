...
public final class UsageXmlEndpoint extends UsageEndpoint {
    public UsageXmlEndpoint() {
        super();
    }

    @Path("/{subresource}.json")
    @GET
    public Response getUsageAsJson(@PathParam("accountSid") final String accountSid,
            @PathParam("subresource") final String subresource, @Context UriInfo info) {
