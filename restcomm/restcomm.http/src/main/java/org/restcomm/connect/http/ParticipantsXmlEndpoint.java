...
public final class ParticipantsXmlEndpoint extends ParticipantsEndpoint {
    ...
    @Path("/{callSid}.json")
    @GET
    public Response getParticipantAsJson(@PathParam("accountSid") final String accountSid,
            @PathParam("conferenceSid") final String conferenceSid, @PathParam("callSid") final String callSid) {
    ...
    public Response getParticipants(@PathParam("accountSid") final String accountSid,
            @PathParam("conferenceSid") final String conferenceSid, @Context UriInfo info) {
