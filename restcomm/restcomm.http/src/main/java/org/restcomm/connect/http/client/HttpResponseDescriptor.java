...
public final class HttpResponseDescriptor {
    ...
    private HttpResponseDescriptor(final URI uri, final int statusCode, final String statusDescription, final String content,
            final long contentLength, final String contentEncoding, final String contentType, final boolean isChunked,
