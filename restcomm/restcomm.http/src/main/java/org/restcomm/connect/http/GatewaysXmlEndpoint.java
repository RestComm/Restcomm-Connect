...
public final class GatewaysXmlEndpoint extends GatewaysEndpoint {
    ...
    @Path("/{sid}.json")
    @POST
    public Response updateGatewayAsJsonPost(@PathParam("accountSid") final String accountSid,
    ...
    @Path("/{sid}.json")
    @PUT
    public Response updateGatewayAsJsonPut(@PathParam("accountSid") final String accountSid, @PathParam("sid") final String sid,
    ...
    @Path("/{sid}")
    @POST
    public Response updateGatewayAsXmlPost(@PathParam("accountSid") final String accountSid, @PathParam("sid") final String sid,
            final MultivaluedMap<String, String> data) {
    ...
    @Path("/{sid}")
    @PUT
    public Response updateGatewayAsXmlPut(@PathParam("accountSid") final String accountSid, @PathParam("sid") final String sid,
            final MultivaluedMap<String, String> data) {
        return updateGateway(accountSid, sid, data, APPLICATION_XML_TYPE);
    }
}
