...
public abstract class IncomingPhoneNumbersEndpoint extends SecuredEndpoint {
    ...
    public void init() throws ObjectInstantiationException {
         ...
         * context.getAttribute("PhoneNumberProvisioningManager"); if(phoneNumberProvisioningManager == null) { final String
         * phoneNumberProvisioningManagerClass = configuration.getString("phone-number-provisioning[@class]"); Configuration
         * phoneNumberProvisioningConfiguration = configuration.subset("phone-number-provisioning"); Configuration
         ...
         * .getObjectInstance(phoneNumberProvisioningManagerClass); ContainerConfiguration containerConfiguration = new
         * ContainerConfiguration(getOutboundInterfaces());
         * phoneNumberProvisioningManager.init(phoneNumberProvisioningConfiguration, telestaxProxyConfiguration,
         * containerConfiguration); context.setAttribute("phoneNumberProvisioningManager", phoneNumberProvisioningManager); }
         */
        ...
        phoneNumberParameters = new PhoneNumberParameters(callbackUrlsConfiguration.getString("voice[@url]"),
                callbackUrlsConfiguration.getString("voice[@method]"), false, callbackUrlsConfiguration.getString("sms[@url]"),
                callbackUrlsConfiguration.getString("sms[@method]"), callbackUrlsConfiguration.getString("fax[@url]"),
                callbackUrlsConfiguration.getString("fax[@method]"), callbackUrlsConfiguration.getString("ussd[@url]"),
    ...
    public Response updateIncomingPhoneNumber(final String accountSid, final String sid,
        ...
        if (phoneNumberProvisioningManager != null
                && (incomingPhoneNumber.isPureSip() == null || !incomingPhoneNumber.isPureSip())) {
            updated = phoneNumberProvisioningManager.updateNumber(convertIncomingPhoneNumbertoPhoneNumber(incomingPhoneNumber),
    ...
    private IncomingPhoneNumber update(final IncomingPhoneNumber incomingPhoneNumber,
    ...
    /*
     * @SuppressWarnings("unchecked") private List<SipURI> getOutboundInterfaces() { final List<SipURI> uris = (List<SipURI>)
     * context.getAttribute(SipServlet.OUTBOUND_INTERFACES); return uris; }
     */
    ...
    public static org.restcomm.connect.provisioning.number.api.PhoneNumber convertIncomingPhoneNumbertoPhoneNumber(
        ...
        return new org.restcomm.connect.provisioning.number.api.PhoneNumber(incomingPhoneNumber.getFriendlyName(),
                incomingPhoneNumber.getPhoneNumber(), null, null, null, null, null, null, null, null,
                incomingPhoneNumber.isVoiceCapable(), incomingPhoneNumber.isSmsCapable(), incomingPhoneNumber.isMmsCapable(),
                incomingPhoneNumber.isFaxCapable(), false);
    }
}
