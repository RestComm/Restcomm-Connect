...
public class GatewaysEndpoint extends SecuredEndpoint {
    ...
    protected Response putGateway(final String accountSid, final MultivaluedMap<String, String> data,
    ...
    protected Response updateGateway(final String accountSid, final String sid, final MultivaluedMap<String, String> data,
            final MediaType responseType) {
        // following 2 things are enough to grant access: 1. a valid authentication token is present. 2 it is a super admin.
        checkAuthenticatedAccount();
        allowOnlySuperAdmin();
