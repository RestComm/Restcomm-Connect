 ...
 */
@ThreadSafe
public final class OutgoingCallerIdListConverter extends AbstractConverter<OutgoingCallerIdList> {
    ...
    @Override
    public JsonElement serialize(OutgoingCallerIdList t, Type type, JsonSerializationContext jsc) {
