 ...
 */
@ThreadSafe
public final class RegistrationListConverter extends AbstractConverter<RegistrationList> {
    ...
    @Override
    public JsonElement serialize(RegistrationList t, Type type, JsonSerializationContext jsc) {
