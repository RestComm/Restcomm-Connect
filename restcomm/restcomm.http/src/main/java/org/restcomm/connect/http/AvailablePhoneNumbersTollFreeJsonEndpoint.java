...
public class AvailablePhoneNumbersTollFreeJsonEndpoint extends AvailablePhoneNumbersEndpoint {
    ...
    public Response getAvailablePhoneNumber(@PathParam("accountSid") final String accountSid,
            ...
            @QueryParam("Contains") String filterPattern, @QueryParam("RangeSize") String rangeSize,
        ...
        if (isoCountryCode != null && !isoCountryCode.isEmpty()) {
            ...
            PhoneNumberSearchFilters listFilters = new PhoneNumberSearchFilters(areaCode, null, null, Boolean.TRUE, null, null,
                    null, null, null, null, null, null, null, null, rangeSizeInt, rangeIndexInt, PhoneNumberType.TollFree);
