 ...
 */
@ThreadSafe
public final class ConferenceDetailRecordListConverter extends AbstractConverter
        implements JsonSerializer<ConferenceDetailRecordList> {
    ...
    private String getNextPageUri(ConferenceDetailRecordList list) {
        String lastSid = (page == getTotalPages()) ? "null"
                : list.getConferenceDetailRecords().get(pageSize - 1).getSid().toString();
