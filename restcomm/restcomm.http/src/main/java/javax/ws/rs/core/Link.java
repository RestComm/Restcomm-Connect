...
import org.restcomm.connect.http.link.JerseyLink;
...
public abstract class Link {
    ...
    public static Link valueOf(String value) {
        Builder b = new JerseyLink.Builder();
        b.link(value);
        return b.build();
    }
    ...
    public static Builder fromMethod(Class<?> resource, String method) {
        //TODO fromUriBuilder(UriBuilder.fromMethod(resource, method));
        throw new UnsupportedOperationException("no equivalent in jaxrs1");
    }
