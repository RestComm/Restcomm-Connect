...
public class MmsCallController extends MediaServerController {
    ...
    public MmsCallController(final ActorRef mrb) {
        ...
        this.initializingRemoteConnection = new State("initializing connection", new InitializingRemoteConnection(source),
                null);
        ...
        this.closingInternalLink = new State("closing link", new EnterClosingInternalLink(source),
                new ExitClosingInternalLink(source));
        ...
        if (this.mediaGroup != null) {
            ...
            if (message.createRecord() && recordingUri != null) {
                ...
                if (duration.equals(0.0)) {
                    ...
                    if (logger.isInfoEnabled()) {
                        logger.info(
                                "Call wraping up recording. File already exists, length: " + (new File(recordingUri).length()));
                    }
                }
    ...
    public void onReceive(Object message) throws Exception {
        ...
        if (logger.isInfoEnabled()) {
            ...
            logger.info("********** MmsCallController " + self.path() + " Processing Message: \"" + klass.getName()
    ...
    private final class InitializingInternalLink extends AbstractAction {
        ...
        public void execute(Object message) throws Exception {
            ...
            // System.out.println("##################### $$ Bridge for Call "+self().path()+" is null or terminated:
            // "+bridge.isTerminated());
            // }
