...
public final class CreateCall implements IExtensionCreateCallRequest {
    ...
    public CreateCall(final String from, final String to, final String username, final String password, final boolean isFromApi,
            final int timeout, final CreateCallType type, final Sid accountId, final Sid parentCallSid,
        ...
        this(from, to, username, password, isFromApi, timeout, type, accountId, parentCallSid, statusCallbackUrl,
                statusCallbackMethod, statusCallbackEvent, "", null);
    }
    ...
    /**
     * IExtensionCreateCallRequest the outboundProxyUsername is a facade to the username field
     *
    ...
    /**
     * IExtensionCreateCallRequest the outboundProxyPassword is a facade to the password field
     *
    ...
    public String toString() {
        return "From: " + from + ", To: " + to + ", Type: " + callType.name() + ", AccountId: " + accountId + ", isFromApi: "
                + isFromApi + ", parentCallSidExists: " + isParentCallSidExists();
    }
}
