...
public final class InitializeOutbound {
    ...
    public InitializeOutbound(final String name, final SipURI from, final SipURI to, final String username,
            ...
            final CreateCallType type, final DaoManager daoManager, final boolean webrtc, final boolean outboundToIms,
            final String imsProxyAddress, final int imsProxyPort) {
    ...
    public InitializeOutbound(final String name, final SipURI from, final SipURI to, final String username,
            final String password, final long timeout, final boolean isFromApi, final String apiVersion, final Sid accountId,
            final CreateCallType type, final DaoManager daoManager, final boolean webrtc) {
        super();
        this.name = name;
        this.from = from;
        this.to = to;
