...
public class ApplicationsApiSyncException extends RvdException {
    ...
    public ApplicationsApiSyncException(String message) {
        super(message);
    }

    public ApplicationsApiSyncException(String message, Throwable throwable) {
    ...
    public ApplicationsApiSyncException setStatusCode(Integer statusCode) {
