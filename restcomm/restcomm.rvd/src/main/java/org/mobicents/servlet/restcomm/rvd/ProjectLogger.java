...
public class ProjectLogger {
    ...
    public ProjectLogger(String projectName, RvdSettings settings,ModelMarshaler marshaler) {
        this.projectName = projectName;
        this.logFilePath = settings.getProjectBasePath(projectName) + File.separator + RvdSettings.PROJECT_LOG_FILENAME;
