...
/**
 * Identity Context holds all identity related entities whose lifecycle follows Restcomm lifecycle, such as keycloak deployment
 * (to be added) and restcomm roles.
 *
