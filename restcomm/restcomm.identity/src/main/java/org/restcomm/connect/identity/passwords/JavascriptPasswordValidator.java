...
public class JavascriptPasswordValidator implements PasswordValidator {
    ...
    /**
     * Returns a number from 0-100 according to the strength of the password passed. In case of error it returns null. The
     * actual implementation of the algorithm is implemented in Javascript hence the name of the class.
     *
     * @param password
     * @return
     */
    private Integer getStrength(String password) {
        ...
        try {
            ...
            logger.error(
                    "Javascript-based password validation mechanism failed. Make sure a proper JAVA implementation is used.",
                    e);
            return null;
        }
    }
