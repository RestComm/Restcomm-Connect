...
public class PhoneNumberProvisioningManagerProvider {
    ...
    /**
     * Tries to retrieve the manager from the Servlet context. If it's not there it creates is, stores it in the context and
     * also returns it.
     *
     * @param context
     * @return
    ...
    public PhoneNumberProvisioningManager get() {
        PhoneNumberProvisioningManager manager = (PhoneNumberProvisioningManager) context
