 ...
 * <td align="left">A pattern to match phone numbers on. Valid characters are '*' and [0-9a-zA-Z]. The '*' character will match
 * any single digit.</td>
 * </tr>
 * <tr>
 ...
 * <td align="left">Given a phone number, find a geographically close number within Distance miles. Distance defaults to 25
 * miles.</td>
 * </tr>
 * <tr>
 ...
 * <td align="left">Specifies the search radius for a Near- query in miles. If not specified this defaults to 25 miles. Maximum
 * searchable distance is 500 miles.</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">InPostalCode</td>
 * <td align="left">Limit results to a particular postal code. Given a phone number, search within the same postal code as that
 * number.</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">InRegion</td>
 * <td align="left">Limit results to a particular region (i.e. State/Province). Given a phone number, search within the same
 * Region as that number.</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">InRateCenter</td>
 * <td align="left">Limit results to a specific rate center, or given a phone number search within the same rate center as that
 * number. Requires InLata to be set as well.</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">InLata</td>
 * <td align="left">Limit results to a specific Local access and transport area (LATA -
 * http://en.wikipedia.org/wiki/Local_access_and_transport_area). Given a phone number, search within the same LATA as that
 * number.</td>
 * </tr>
 * </tbody>
 * </table>
...
public class PhoneNumberSearchFilters {
    ...
    public PhoneNumberSearchFilters(String areaCode, Pattern filterPattern, Boolean smsEnabled, Boolean mmsEnabled,
            Boolean voiceEnabled, Boolean faxEnabled, Boolean ussdEnabled, String nearNumber, String nearLatLong,
            String distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, int rangeSize,
