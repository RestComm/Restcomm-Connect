 ...
 *
 * <p>
 * Its init method will be called on startup to initialize and pass the parameters found in restcomm.xml
 * phone-number-provisioning tag as an Apache Commons Configuration Object
 * </p>
 * <p>
...
public interface PhoneNumberProvisioningManager {
    ...
    /**
     * Purchase a given phone number previously searched through {@link #searchForNumbers(String, PhoneNumberSearchFilters)
     ...
     * @param phoneNumberParameters parameters set on the phone number purchase so the Provider knows where to route incoming
     *        messages (be it voice or SMS, MMS, USSD)
     ...
     *
     * @return a list of 2 letters Country Code as defined per http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2, representing all
     *         countries where a number can be bought or searched in.
     */
