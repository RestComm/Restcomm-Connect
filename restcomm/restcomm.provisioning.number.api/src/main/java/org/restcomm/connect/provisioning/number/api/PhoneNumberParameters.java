 ...
 * <td align="left">The URL in host:port format that the DID provider should request when somebody dials the new phone
 * number.</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">VoiceMethod</td>
 * <td align="left">The method that should be used to request the VoiceUrl. Only SIP or SIPS supported currently. Defaults to
 * SIP.</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">doVoiceCallerIdLookup</td>
 * <td align="left">Do a lookup of a caller's name from the CNAM database if the service provider support it. Either true or
 * false. Defaults to false..</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">SmsUrl</td>
 * <td align="left">The URL in host:port format (SIP, SMPP, or SS7 MAP) that the DID provider should request when somebody sends
 * an SMS to the phone number.</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">SMSMethod</td>
 * <td align="left">The method that should be used to request the SmsUrl. SS7, SMPP, SIP or SIPS supported currently. Defaults
 * to SIP. If SMPP or SS7 are used, the URL of the SMSC will be provided</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">UssdUrl</td>
 * <td align="left">The URL in host:port format that the DID provider should request when somebody sends a USSD message to the
 * phone number.</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">UssdMethod</td>
 * <td align="left">The method that should be used to request the UssdUrl. SS7, SIP or SIPS supported currently. Defaults to
 * SIP. If SS7 is used, the URL of the USSD will be provided</td>
 * </tr>
 * <tr>
 * <td class='notranslate' align="left">FaxUrl</td>
 * <td align="left">The URL in host:port format that the DID provider should request when somebody sends a Fax message to the
 * phone number.</td>
 * </tr>
 * <tr>
