...
/**
 * Test for Multipart Content type. UFone Issue 31380. RESTCOMM-330 https://telestax.atlassian.net/browse/RESTCOMM-330
 *
...
public class TestMultipartContent {
    ...
    public synchronized void testDialConference() throws InterruptedException {
        ...
        bobCall.initiateOutgoingCall(bobContact, dialConf, null, multipartBody, "multipart", "mixed;boundary=uniqueBoundary",
                null, null);
        ...
        georgeCall.initiateOutgoingCall(georgeContact, dialConf, null, multipartBody, "multipart",
                "mixed;boundary=uniqueBoundary", null, null);
