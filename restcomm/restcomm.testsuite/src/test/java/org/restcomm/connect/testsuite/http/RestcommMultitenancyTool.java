...
public class RestcommMultitenancyTool {
    ...
    public int get(String url, String credentialUsername, String credentialPassword)
    ...
    public int delete(String url, String credentialUsername, String credentialPassword)
            throws ClientProtocolException, IOException {
        CloseableHttpClient client = HttpClients.createDefault();
        CloseableHttpResponse apiResponse = null;
    ...
    public int update(String url, String credentialUsername, String credentialPassword, Map<String, String> params)
            throws ClientProtocolException, IOException {
        CloseableHttpClient client = HttpClients.createDefault();
        CloseableHttpResponse apiResponse = null;
