...
public class SupervisorEndpointAccessControlTest extends EndpointTest {
    ...
    public void testSuperAdminPermissionTest() {
        JsonObject metrics = MonitoringServiceTool.getInstance().getMetrics(deploymentUrl.toString(), superAdminAccountSid,
                superAdminAuthToken);
    ...
    public void testSuperAdmin2PermissionTest() {
        JsonObject metrics = MonitoringServiceTool.getInstance().getMetrics(deploymentUrl.toString(), superAdmin2AccountSid,
