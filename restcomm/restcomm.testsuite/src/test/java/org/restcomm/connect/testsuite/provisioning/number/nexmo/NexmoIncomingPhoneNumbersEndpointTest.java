...
public class NexmoIncomingPhoneNumbersEndpointTest {
    ...
    public void testPurchasePhoneNumberSuccess() {
        ...
        assertTrue(NexmoIncomingPhoneNumbersEndpointTestUtils.match(jsonResponse.toString(),
                NexmoIncomingPhoneNumbersEndpointTestUtils.jSonResultPurchaseNumber));
    }
    ...
    public void testDeletePhoneNumberSuccess() {
        ...
        System.out.println(jsonResponse.toString());
        assertTrue(NexmoIncomingPhoneNumbersEndpointTestUtils.match(jsonResponse.toString(),
                NexmoIncomingPhoneNumbersEndpointTestUtils.jSonResultDeletePurchaseNumber));
    ...
    public void testUpdatePhoneNumberSuccess() {
        ...
        System.out.println(jsonResponse.toString());
        assertTrue(NexmoIncomingPhoneNumbersEndpointTestUtils.match(jsonResponse.toString(),
                NexmoIncomingPhoneNumbersEndpointTestUtils.jSonResultUpdatePurchaseNumber));
        ...
        System.out.println(jsonResponse.toString());
        assertTrue(NexmoIncomingPhoneNumbersEndpointTestUtils.match(jsonResponse.toString(),
                NexmoIncomingPhoneNumbersEndpointTestUtils.jSonResultUpdateSuccessPurchaseNumber));
