...
public class CreateGatewaysTool {
    ...
    public JsonObject createGateway(String deploymentUrl, String friendlyName, String username, String password, String proxy,
            String register, String ttl) {
    ...
    public JsonObject updateGateway(String deploymentUrl, String sid, String friendlyName, String username, String password,
            String proxy, String register, String ttl) {
