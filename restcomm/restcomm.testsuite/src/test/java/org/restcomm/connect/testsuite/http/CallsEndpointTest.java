...
public class CallsEndpointTest {
    ...
    public void getCallsList() {
        ...
        JsonObject secondPage = (JsonObject) RestcommCallsTool.getInstance().getCalls(deploymentUrl.toString(), adminAccountSid,
                adminAuthToken, 2, null, true);
    ...
    public void getCallsListUsingPageSize() {
        ...
        JsonArray lastPageCallsArray = lastPage.get("calls").getAsJsonArray();
        assertEquals("CAe803a594ac1649d98855eafc7535ed41",
                lastPageCallsArray.get(lastPageCallsArray.size() - 1).getAsJsonObject().get("sid").getAsString());
        assertTrue(lastPageCallsArray.size() == 48);
        assertTrue(lastPage.get("start").getAsInt() == 400);
        assertTrue(lastPage.get("end").getAsInt() == 448);
    ...
    public void getCallsListFilteredByRecipient() {
        ...
        assertTrue(
                allCalls.get("calls").getAsJsonArray().size() == filteredCallsByRecipient.get("calls").getAsJsonArray().size());
    }
    ...
    public void getCallsListFilteredByStartTime() {
        ...
        assertTrue(
                allCalls.get("calls").getAsJsonArray().size() == filteredCallsByStartTime.get("calls").getAsJsonArray().size());
    }
    ...
    public void getCallsListFilteredUsingMultipleFilters() {
        ...
        JsonObject filteredCallsUsingMultipleFilters = RestcommCallsTool.getInstance()
                .getCallsUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getCallsListIncludingSubAccounts() {
        ...
        JsonObject calls = RestcommCallsTool.getInstance().getCallsUsingFilter(deploymentUrl.toString(), topLevelAccountSid,
                commonAuthToken, filters);
        ...
        filters.put("Page", "1");
        calls = RestcommCallsTool.getInstance().getCallsUsingFilter(deploymentUrl.toString(), topLevelAccountSid,
                commonAuthToken, filters);
        ...
        calls = RestcommCallsTool.getInstance().getCallsUsingFilter(deploymentUrl.toString(), subAccount1, commonAuthToken,
                filters);
        assertEquals(33, calls.get("calls").getAsJsonArray().size());
        // retrieve first level child (with no grandchildren) account cdrs
        calls = RestcommCallsTool.getInstance().getCallsUsingFilter(deploymentUrl.toString(), subAccount2, commonAuthToken,
                filters);
        assertEquals(19, calls.get("calls").getAsJsonArray().size());
        // retrieve second level child cdrs
        calls = RestcommCallsTool.getInstance().getCallsUsingFilter(deploymentUrl.toString(), subAccount11, commonAuthToken,
                filters);
        assertEquals(18, calls.get("calls").getAsJsonArray().size());
        // retrieve third level child cdrs
        calls = RestcommCallsTool.getInstance().getCallsUsingFilter(deploymentUrl.toString(), subAccount111, commonAuthToken,
                filters);
        ...
        calls = RestcommCallsTool.getInstance().getCallsUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken,
                filters);
