...
public class OutboudProxyCallsTest {
    ...
    public void before() throws Exception {
        ...
        fallbackProxyPhone = fallbackProxySipStack.createSipPhone("127.0.0.1", SipStack.PROTOCOL_UDP, 5080,
                fallbackProxyContact);
    ...
    public void createCallAndFallback() throws InterruptedException {
        ...
        JsonObject activeProxyJsonObject = OutboundProxyTool.getInstance().getActiveProxy(deploymentUrl.toString(),
        ...
        activeProxyJsonObject = OutboundProxyTool.getInstance().getActiveProxy(deploymentUrl.toString(), adminAccountSid,
                adminAuthToken);
