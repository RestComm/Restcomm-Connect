...
public class RestcommUsageRecordsTool {
    ...
    public JsonElement getUsageRecordsDaily(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
        return getUsageRecords(deploymentUrl, username, authToken, "Daily", categoryStr, "", "", null, null, json);
    }

    public JsonElement getUsageRecordsMonthly(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
        return getUsageRecords(deploymentUrl, username, authToken, "Monthly", categoryStr, "", "", null, null, json)
                .getAsJsonArray();
    }

    public JsonElement getUsageRecordsYearly(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
        return getUsageRecords(deploymentUrl, username, authToken, "Yearly", categoryStr, "", "", null, null, json);
    }

    public JsonElement getUsageRecordsAllTime(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
        return getUsageRecords(deploymentUrl, username, authToken, "AllTime", categoryStr, "", "", null, null, json);
    }

    public JsonElement getUsageRecordsToday(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
        return getUsageRecords(deploymentUrl, username, authToken, "Today", categoryStr, "", "", null, null, json);
    }

    public JsonElement getUsageRecordsYesterday(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
        return getUsageRecords(deploymentUrl, username, authToken, "Yesterday", categoryStr, "", "", null, null, json);
    }

    public JsonElement getUsageRecordsThisMonth(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
        return getUsageRecords(deploymentUrl, username, authToken, "ThisMonth", categoryStr, "", "", null, null, json);
    }

    public JsonElement getUsageRecordsLastMonth(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
        return getUsageRecords(deploymentUrl, username, authToken, "LastMonth", categoryStr, "", "", null, null, json);
    }

    public JsonElement getUsageRecordsWeekly(String deploymentUrl, String username, String authToken, String categoryStr,
            Boolean json) {
    ...
    public JsonElement getUsageRecords(String deploymentUrl, String username, String authToken, String subresource,
            String categoryStr, Boolean json) {
