...
public final class CallTest {
    ...
    public void before() throws Exception {
        ...
        phone = receiver.createSipPhone("127.0.0.1", SipStack.PROTOCOL_UDP, 5060, "sip:+17778889999@127.0.0.1:5070");
        phone2 = receiver.createSipPhone("127.0.0.1", SipStack.PROTOCOL_UDP, 5060, "sip:+17778889998@127.0.0.1:5070");
    }
    ...
    public synchronized void testInboundRedirectAndSms() {
        ...
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334444@127.0.0.1:5060", null, body,
    ...
    public synchronized void testPauseRejectBusy() {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334445@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
    ...
    public synchronized void testPauseRejectRejected() throws InterruptedException {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334446@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
    ...
    public synchronized void testPlaySay() throws InterruptedException {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334447@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
    ...
    public synchronized void testRecord() throws InterruptedException {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334448@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
    ...
    public synchronized void testFax() throws InterruptedException {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334449@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
    ...
    public synchronized void testGather() throws InterruptedException {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334450@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
    ...
    public synchronized void testGatherAndFollowAction() throws InterruptedException {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334453@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
    ...
    public synchronized void testDialConference() throws InterruptedException {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334451@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
    ...
    public synchronized void testDialFork() throws InterruptedException {
        ...
        phone.setLoopback(true);
        final SipCall call = phone.createSipCall();
        call.initiateOutgoingCall("sip:+17778889999@127.0.0.1:5070", "sip:+12223334452@127.0.0.1:5060", null, body,
                "application", "sdp", null, null);
        assertLastOperationSuccess(call);
        assertTrue(call.waitOutgoingCallResponse(5 * 1000));
        final int response = call.getLastReceivedResponse().getStatusCode();
