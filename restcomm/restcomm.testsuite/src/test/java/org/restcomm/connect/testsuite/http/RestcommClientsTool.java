...
public class RestcommClientsTool {
    ...
    private static Logger logger = Logger.getLogger(RestcommClientsTool.class);
    ...
    private String getAccountsUrl(String deploymentUrl, String username, Boolean json) {
        ...
        accountsUrl = deploymentUrl + "/2012-04-24/Accounts/" + username + "/Clients" + ((json) ? ".json" : "");

        return accountsUrl;
    }
    
    public JsonObject getClients(String deploymentUrl, String username, String authToken) {
        return (JsonObject) getClients(deploymentUrl, username, authToken, null, null, true);
    }
    
    public JsonObject getClients(String deploymentUrl, String username, String authToken, Integer page, Integer pageSize,
            Boolean json) {
        ...
        if (json) {
            ...
            xstream.alias("clientslist", ClientList.class);
     ...
     * @return
     */
    public JsonObject getClientsUsingFilter(String deploymentUrl, String username, String authToken,
