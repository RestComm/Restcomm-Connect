...
public class BandwidthAvailablePhoneNumbersEndpointTest {
    ...
    public void testReturnAreaCodeSearch() {
        ...
        assertTrue(jsonResponse.get(0).getAsJsonObject().toString()
                .equalsIgnoreCase(BandwidthAvailablePhoneNumbersEndpointTestUtils.firstJSonResult201AreaCode));
    }
    ...
    public void testReturnZipCodeSearch() {
        ...
        assertTrue(jsonResponse.size() == 1);
        assertTrue(jsonResponse.get(0).getAsJsonObject().toString()
                .equalsIgnoreCase(BandwidthAvailablePhoneNumbersEndpointTestUtils.firstJSONResult27601ZipCode));
    }
    ...
    public void testSearchForTollFreeNumbers() {
        ...
        System.out.println(jsonResponse.get(0).getAsJsonObject().toString());
        assertTrue(jsonResponse.get(0).getAsJsonObject().toString()
                .equalsIgnoreCase(BandwidthAvailablePhoneNumbersEndpointTestUtils.validTollFreeJsonResult));
    }
    ...
    public void testSearchForTollFreeNumbersInvalidPattern() {
        ...
        ClientResponse clientResponse = webResource.queryParam("RangeSize", "2").queryParam("Contains", "7**")
