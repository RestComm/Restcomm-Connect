...
public class CreateCallsTest {
    ...
    public void createCallSipUriAllowFromModificationTest() throws InterruptedException {
        ...
        assertTrue(bobCall.waitForIncomingCall(5000));
        FromHeader fromHeader = (FromHeader) bobCall.getLastReceivedRequest().getRequestEvent().getRequest()
    ...
    /*
     * Calls REST API will create call to sipUnit client 'george' but there will be no answer within the timeout interval
     * (10sec) Restcomm should cancel the call and cleanup
     */
    @Test
    public void createCallNumberTestNoAnswer() throws InterruptedException, ParseException {

        stubFor(post(urlPathEqualTo("/1111"))
                .willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialClient)));
    ...
    /*
     * Calls REST API will create call to sipUnit client 'george' which will answer, next will create call to client 'alice' but
     * there will be no answer within the timeout interval (10sec) and Restcomm should cancel the call to alice and disconnect
     * 'george' call
     */
    @Test
    ...
    /*
     * Calls REST API will create call to sipUnit client 'george' which will answer, next will create call to client 'alice' but
     * the response will be 486 Busy here and Restcomm should disconnect 'george' call
     */
    @Test
