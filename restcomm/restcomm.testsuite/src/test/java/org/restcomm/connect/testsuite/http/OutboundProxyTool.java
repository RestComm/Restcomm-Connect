...
public class OutboundProxyTool {
    ...
    public JsonObject switchProxy(String deploymentUrl, String username, String authToken) {
        ...
        response = webResource.path("switchProxy").accept(MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML)
                .get(String.class);
    ...
    public JsonObject getActiveProxy(String deploymentUrl, String username, String authToken) {
        ...
        response = webResource.path("getActiveProxy").accept(MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML)
                .get(String.class);
