...
public class NexmoAvailablePhoneNumbersEndpointTest {
    ...
    public void testSearchESPhoneNumbers700Pattern() {
        ...
        assertTrue(jsonResponse.get(0).getAsJsonObject().toString()
                .equalsIgnoreCase(NexmoAvailablePhoneNumbersEndpointTestUtils.jsonResultES700));
    }
    ...
    public void testSearchUSPhoneNumbersRangeIndexAndSize() {
        ...
        ClientResponse clientResponse = webResource.queryParam("RangeSize", "5").queryParam("RangeIndex", "2")
        ...
        System.out.println((jsonResponse.get(0).getAsJsonObject().toString()));
        assertTrue(jsonResponse.get(0).getAsJsonObject().toString()
                .equalsIgnoreCase(NexmoAvailablePhoneNumbersEndpointTestUtils.jsonResultUSRange));
    }
    ...
    public void testSearchUSLocalPhoneNumbersWith501AreaCode() {
        ...
        System.out.println((jsonResponse.get(0).getAsJsonObject().toString()));
        assertTrue(jsonResponse.get(0).getAsJsonObject().toString()
                .equalsIgnoreCase(NexmoAvailablePhoneNumbersEndpointTestUtils.firstJSonResult501AreaCode));
    }
    ...
    public void testSearchCALocalPhoneNumbersWith450AreaCode() {
        ...
        System.out.println((jsonResponse.get(0).getAsJsonObject().toString()));
        assertTrue(jsonResponse.get(0).getAsJsonObject().toString()
                .equalsIgnoreCase(NexmoAvailablePhoneNumbersEndpointTestUtils.firstJSonResultCA450AreaCode));
    }
    ...
    public void testSearchCALocalPhoneNumbersWithContainsAreaCode() {
        ...
        System.out.println((jsonResponse.get(0).getAsJsonObject().toString()));
        assertTrue(jsonResponse.get(0).getAsJsonObject().toString()
                .equalsIgnoreCase(NexmoAvailablePhoneNumbersEndpointTestUtils.firstJSonResultCA418AreaCode));
    }
