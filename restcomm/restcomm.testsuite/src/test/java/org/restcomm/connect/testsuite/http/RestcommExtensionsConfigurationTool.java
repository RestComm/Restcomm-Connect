...
public class RestcommExtensionsConfigurationTool {
    ...
    public JsonObject getConfiguration(String deploymentUrl, String adminUsername, String adminAuthToken,
    ...
    public JsonObject updateConfiguration(String deploymentUrl, String adminUsername, String adminAuthToken,
            String extensionSid, MultivaluedMap<String, String> configurationParams) {
        return updateConfiguration(deploymentUrl, adminUsername, adminAuthToken, extensionSid, configurationParams, false);
    }

    public JsonObject updateConfiguration(String deploymentUrl, String adminUsername, String adminAuthToken,
            String extensionSid, MultivaluedMap<String, String> configurationParams, Boolean xml) {
        JsonParser parser = new JsonParser();
        JsonObject jsonResponse = null;
