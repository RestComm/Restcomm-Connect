...
public class VoxboneIncomingPhoneNumbersEndpointTest {
    ...
    /*
     * Check the list of available Countries http://www.voxbone.com/apidoc/resource_InventoryServiceRest.html#path__country.html
     */
    @Test
    ...
    public void testPurchaseAndDeletePhoneNumberSuccess() {
        ...
        System.out.println(jsonResponse.toString());
        assertTrue(VoxboneIncomingPhoneNumbersEndpointTestUtils.match(jsonResponse.toString(),
                VoxboneIncomingPhoneNumbersEndpointTestUtils.jSonResultPurchaseNumber));
    ...
    // webResource.type(MediaType.APPLICATION_FORM_URLENCODED_TYPE).accept("application/json").post(ClientResponse.class,
    // formData);
    // assertTrue(clientResponse.getStatus() == 200);
    // String response = clientResponse.getEntity(String.class);
    // System.out.println(response);
    ...
    // webResource = jerseyClient.resource(provisioningURL);
    // clientResponse =
    // webResource.type(MediaType.APPLICATION_FORM_URLENCODED_TYPE).accept("application/json").delete(ClientResponse.class);
    // assertTrue(clientResponse.getStatus() == 204);
    // }
