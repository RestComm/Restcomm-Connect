...
public class ConferenceParticipantsEndpointTest {
    ...
    public void getParticipantsListRunningConference() {
        JsonObject page = RestcommConferenceParticipantsTool.getInstance().getParticipants(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken, runningConferenceSid);
    ...
    public void getParticipantsListCompletedConference() {
        JsonObject page = RestcommConferenceParticipantsTool.getInstance().getParticipants(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken, completedConferenceSid);
        int totalSize = page.get("total").getAsInt();
        JsonArray pageCallsArray = page.get("calls").getAsJsonArray();
        int pageCallsArraySize = pageCallsArray.size();
    ...
    @Test
    @Ignore // Pending issue https://github.com/RestComm/Restcomm-Connect/issues/1135
