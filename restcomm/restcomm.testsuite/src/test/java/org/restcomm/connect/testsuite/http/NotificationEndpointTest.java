...
public class NotificationEndpointTest extends EndpointTest {
    ...
    public void getNotificationList() {
        JsonObject firstPage = NotificationEndpointTool.getInstance().getNotificationList(deploymentUrl.toString(),
    ...
    public void getNotificationListUsingPageSize() {
        JsonObject firstPage = NotificationEndpointTool.getInstance().getNotificationList(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken, null, 10, true);
        JsonArray firstPageNotificationsArray = firstPage.get("notifications").getAsJsonArray();
        assertTrue(firstPageNotificationsArray.size() == 10);
        assertTrue(firstPage.get("start").getAsInt() == 0);
        assertTrue(firstPage.get("end").getAsInt() == 9);

        JsonObject secondPage = (JsonObject) NotificationEndpointTool.getInstance()
                .getNotificationList(deploymentUrl.toString(), adminAccountSid, adminAuthToken, 2, 10, true);
        ...
        JsonObject lastPage = (JsonObject) NotificationEndpointTool.getInstance().getNotificationList(deploymentUrl.toString(),
    ...
    public void getNotificationListFilteredByStartTime() {
        ...
        JsonObject filteredNotificationsByStartTime = NotificationEndpointTool.getInstance()
                .getNotificationListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getNotificationListFilteredByEndTime() {
        ...
        JsonObject filteredNotificationsByEndTime = NotificationEndpointTool.getInstance()
                .getNotificationListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getNotificationListFilteredByErrorCode() {
        ...
        JsonObject filteredNotificationsByErrorCode = NotificationEndpointTool.getInstance()
                .getNotificationListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getNotificationListFilteredByRequestUrl() {
        Map<String, String> filters = new HashMap<String, String>();
        filters.put("RequestUrl",
                "http://instance1.restcomm.com:8080/restcomm/recordings/RE50675909d9c94acda36f0e119b6cb432.wav");

        JsonObject filteredNotificationsByRequestUrl = NotificationEndpointTool.getInstance()
                .getNotificationListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getNotificationListFilteredByMessageText() {
        ...
        JsonObject filteredNotificationsByMessageText = NotificationEndpointTool.getInstance()
                .getNotificationListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
