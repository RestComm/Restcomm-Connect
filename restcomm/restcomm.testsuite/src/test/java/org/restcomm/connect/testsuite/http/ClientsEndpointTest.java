...
public class ClientsEndpointTest {
    ...
    public void clientRemovalBehaviour() {
        ...
        WebResource resource = jersey
                .resource(getResourceUrl("/2012-04-24/Accounts/" + developerAccountSid + "/Clients/" + removedClientSid));
    ...
    public void updateClientWithWeakPasswordShouldFail() {
        ...
        Client jersey = getClient(developerUsername, developeerAuthToken);
        WebResource resource = jersey
                .resource(getResourceUrl("/2012-04-24/Accounts/" + developerAccountSid + "/Clients/" + updateClientSid));
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("Password", "1234"); // this is a very weak password
    ...
    /**
     * createClientTestWithInvalidCharacters https://github.com/RestComm/Restcomm-Connect/issues/1979
     *
     ...
     */
    @Test
    public void createClientTestWithInvalidCharacters()
        ...
        ClientResponse response = resource.accept(MediaType.APPLICATION_JSON).post(ClientResponse.class, params);
        Assert.assertEquals(400, response.getStatus());
        Assert.assertTrue("Response should contain 'invalid' term",
                response.getEntity(String.class).toLowerCase().contains("invalid"));
    }
