...
public class BandwidthIncomingPhoneNumbersEndpointTest {
    ...
    public void testBuyNumber() {
        ...
        assertTrue(BandwidthIncomingPhoneNumbersEndpointTestUtils.match(jsonResponse.toString(),
                BandwidthIncomingPhoneNumbersEndpointTestUtils.jSonResultPurchaseNumber));
    }
    ...
    public void testCancelNumber() {
        ...
        if (clientResponse.getStatus() == 200) {
            ...
            System.out.println(jsonResponse.toString());
            assertTrue(BandwidthIncomingPhoneNumbersEndpointTestUtils.match(jsonResponse.toString(),
                    BandwidthIncomingPhoneNumbersEndpointTestUtils.jSonResultDeletePurchaseNumber));
        } else {
