...
public class ConferenceEndpointTest {
    ...
    public void getConferencesFilteredByStatus() {
        ...
        JsonObject allConferencesObject = RestcommConferenceTool.getInstance().getConferences(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken);

        JsonObject filteredConferencesByStatusObject = RestcommConferenceTool.getInstance()
                .getConferencesUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
        ...
        assertTrue(allConferencesObject.get("conferences").getAsJsonArray().size() > filteredConferencesByStatusObject
                .get("conferences").getAsJsonArray().size());
    }
    ...
    public void getConferencesFilteredByFriendlyName() {
        ...
        JsonObject filteredConferencesByFNObject = RestcommConferenceTool.getInstance()
                .getConferencesUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
        ...
        assertTrue(allConferencesObject.get("conferences").getAsJsonArray().size() == filteredConferencesByFNObject
                .get("conferences").getAsJsonArray().size());
    }
