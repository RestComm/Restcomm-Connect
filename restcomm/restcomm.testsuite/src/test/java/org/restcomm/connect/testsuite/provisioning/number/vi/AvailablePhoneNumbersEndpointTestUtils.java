...
public class AvailablePhoneNumbersEndpointTestUtils {
    public static String body501AreaCode = "<response id=\"7bf8a6c56f594126a6cdecadb430b672\"><header><sessionid>d46146b4132d611304269388cffabb17</sessionid></header><body><search><name>npa = '510' </name>"
            + "<status>Results Found</status><statuscode>100</statuscode>" + "<state><name>CA</name><lata>"
