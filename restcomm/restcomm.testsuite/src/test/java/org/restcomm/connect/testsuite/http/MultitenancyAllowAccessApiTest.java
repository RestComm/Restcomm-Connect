...
public class MultitenancyAllowAccessApiTest {
    ...
    private enum Endpoint {
        ...
        INCOMING_PHONE_NUMBERS("IncomingPhoneNumbers", true, false, true, true, new HashMap<String, String>() {
            {
                put("PhoneNumber", "1111");
                put("AreaCode", "100");
            }
        }, "PNff22dc8d1cdf4d449d666ac09f0bb110", "PN9f9cf955aeb94ebb9d2e09cead5683a4"), CALLS("Calls", true, false, false,
                false, null, "CA9aa1b61e9b864477a820d5c1c9d9bb7d",
                "CAc6a057e16aa74cb0923c538725ffcf01"), SMS_MESSAGES("SMS/Messages", true, false, false, false, null,
    ...
    public void accountsApi() throws ClientProtocolException, IOException {
        ...
        statusCode = RestcommMultitenancyTool.getInstance().get(baseUrl + jsonExtension + "/" + subaccountbAccountSid,
                primaryUsername, accountsPassword);
        assertTrue(statusCode == httpOk);
        statusCode = RestcommMultitenancyTool.getInstance().post(baseUrl + "/" + subaccountbAccountSid, primaryUsername,
                accountsPassword, new HashMap<String, String>() {
                    {
                        put("EmailAddress", "test2@test.com");
                        put("Password", "RestComm12");
                    }
                });
        assertTrue(statusCode == httpOk);
        ...
        statusCode = RestcommMultitenancyTool.getInstance().update(baseUrl + jsonExtension + "/" + subaccountbAccountSid,
    ...
    public void applicationsApi() throws ClientProtocolException, IOException {
        ...
        int statusCode = RestcommMultitenancyTool.getInstance().get(baseUrl + jsonExtension, primaryUsername, accountsPassword);
        assertTrue(statusCode == httpOk);
        statusCode = RestcommMultitenancyTool.getInstance().get(baseUrl + "/" + primaryApplicationSid + jsonExtension,
                primaryUsername, accountsPassword);
        assertTrue(statusCode == httpOk);
        statusCode = RestcommMultitenancyTool.getInstance().post(baseUrl + jsonExtension, primaryUsername, accountsPassword,
                new HashMap<String, String>() {
                    {
                        put("FriendlyName", "TEST");
                    }
                });
        assertTrue(statusCode == httpOk);
        statusCode = RestcommMultitenancyTool.getInstance().post(baseUrl + "/" + primaryApplicationSid + jsonExtension,
                primaryUsername, accountsPassword, new HashMap<String, String>() {
                    {
                        put("FriendlyName", "TEST123");
                    }
                });
        assertTrue(statusCode == httpOk);
        ...
        // get single
        statusCode = RestcommMultitenancyTool.getInstance().get(baseUrl + "/" + primaryApplicationSid + jsonExtension,
                adminAccountSid, accountsPassword);
        assertTrue(statusCode == httpOk);
        // create
        statusCode = RestcommMultitenancyTool.getInstance().post(baseUrl + jsonExtension, adminAccountSid, accountsPassword,
                new HashMap<String, String>() {
                    {
                        put("FriendlyName", "TEST");
                    }
        ...
        // update
        statusCode = RestcommMultitenancyTool.getInstance().post(baseUrl + "/" + primaryApplicationSid + jsonExtension,
                adminAccountSid, accountsPassword, new HashMap<String, String>() {
                    {
                        put("FriendlyName", "TEST123");
                    }
                });
