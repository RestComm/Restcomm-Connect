...
public class OutboundProxyEndpointTest {
    ...
    public void switchProxyTest() {
        ...
        // Switch to fallback
        JsonObject switchProxyJsonObject = OutboundProxyTool.getInstance().switchProxy(deploymentUrl.toString(),
        ...
        switchProxyJsonObject = OutboundProxyTool.getInstance().switchProxy(deploymentUrl.toString(), adminAccountSid,
                adminAuthToken);
        activeProxy = switchProxyJsonObject.get("ActiveProxy").getAsString();
        assertTrue(activeProxy.equalsIgnoreCase(primaryProxy));
