...
/**
 * Tests for the Dial forking Created by gvagenas on 12/19/15.
 */
...
public class DialForkTest {
    ...
    @Test
    public synchronized void testDialForkNoAnswerButHenrique()
    ...
    @Test
    public synchronized void testDialForkNoAnswerButFromAliceClient()
            throws InterruptedException, ParseException, MalformedURLException {
        stubFor(get(urlPathEqualTo("/1111"))
                .willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialFork)));
    ...
    @Test
    public synchronized void testDialForkToNotRegisteredClientDialSipFirst()
            throws InterruptedException, ParseException, MalformedURLException {
    ...
    @Test
    public synchronized void testDialForkToNotRegisteredClientDialClientFirst()
            throws InterruptedException, ParseException, MalformedURLException {
        stubFor(get(urlPathEqualTo("/1111")).willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml")
    ...
    public synchronized void testDialForkNoAnswer() throws InterruptedException, ParseException, MalformedURLException {
        ...
        stubFor(get(urlPathEqualTo("/1111"))
                .willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialForkWithTimeout)));
    ...
    @Test
    @Ignore // Passes only when run individually. Doesn't pass when run with the rest of the tests
    public synchronized void testDialForkWithReInviteBeforeDialForkStarts_CancelCall()
            throws InterruptedException, ParseException, MalformedURLException {
    ...
    @Test
    @Ignore // Passes only when run individually. Doesn't pass when run with the rest of the tests
    public synchronized void testDialForkWithReInviteAfterDialStarts_CancelCall()
            throws InterruptedException, ParseException, MalformedURLException {

        stubFor(get(urlPathEqualTo("/1111"))
                .willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialClientAlice)));
    ...
    @Test
    public synchronized void testDialForkNoAnswerWith183FromAlice()
            throws InterruptedException, ParseException, MalformedURLException {
    ...
    @Test
    public synchronized void testDialForkNoAnswerAndNoResponseFromAlice()
            throws InterruptedException, ParseException, MalformedURLException {
    ...
    public synchronized void testDialForkNoAnswerWith183() throws InterruptedException, ParseException, MalformedURLException {
        ...
        stubFor(get(urlPathEqualTo("/1111")).willReturn(
                aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialForkWithTimeout15)));
    ...
    public synchronized void testDialForkNoAnswerExecuteRCML_ReturnedFromActionURL()
            throws InterruptedException, ParseException, MalformedURLException {
        ...
        assertTrue(fotiniCall.sendIncomingCallResponse(Response.OK, "OK-Fotini", 3600, receivedBody, "application", "sdp", null,
                null));
    ...
    @Test
    public synchronized void testDialForkEveryoneBusyExecuteRCML_ReturnedFromActionURL()
            throws InterruptedException, ParseException, MalformedURLException {
    ...
    public void testDialClientAliceWithPlay() throws ParseException, InterruptedException, MalformedURLException {
        stubFor(get(urlPathEqualTo("/1111")).willReturn(
                aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialAliceRcmlWithPlay)));
    ...
    public void testDialClientAliceWithInvalidPlayFile() throws ParseException, InterruptedException, MalformedURLException {
        stubFor(get(urlPathEqualTo("/1111")).willReturn(
                aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialAliceRcmlWithInvalidPlay)));
    ...
    @Test
    public synchronized void testDialSequentialFirstCallTimeouts()
            throws InterruptedException, ParseException, MalformedURLException {
        stubFor(get(urlPathEqualTo("/1111"))
                .willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialSequential)));
    ...
    @Test
    public synchronized void testDialForkWithServerErrorReponse()
            throws InterruptedException, ParseException, MalformedURLException {
        stubFor(get(urlPathEqualTo("/1111")).willReturn(
                aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialForkTwoSipUrisRcml)));
