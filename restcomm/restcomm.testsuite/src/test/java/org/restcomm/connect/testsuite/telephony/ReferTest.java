...
/**
 * Test for SIP Refer support according to the RFC5589 spec in order to provide call transfer capabilities to deskphone sip
 * clients that use SIP Refer to implement call transfer.
 */
...
public class ReferTest {
    ...
    public void testTransfer() throws ParseException, InterruptedException, MalformedURLException, SipException {
        ...
        stubFor(get(urlPathEqualTo("/1111"))
                .willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialGeorgeRcml)));

        stubFor(get(urlPathEqualTo("/2222")).withQueryParam("ReferTarget", equalTo("alice"))
    ...
    @Test
    public void testTransferToNumberWithPlusSign()
            throws ParseException, InterruptedException, MalformedURLException, SipException {
    ...
    @Test
    public void testTransferWithAbsentReferUrlAndApplication()
            throws ParseException, InterruptedException, MalformedURLException, SipException {
    ...
    @Test
    public void testTransferWithOutOfDialogRefer()
            throws ParseException, InterruptedException, MalformedURLException, SipException {
    ...
    @Test
    public void testTransferIncorrectReferTarget()
            throws ParseException, InterruptedException, MalformedURLException, SipException {

        stubFor(get(urlPathEqualTo("/1111"))
                .willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialGeorgeRcml)));

        stubFor(get(urlPathEqualTo("/2222")).withQueryParam("ReferTarget", equalTo("joe"))
                .willReturn(aResponse().withStatus(200).withHeader("Content-Type", "text/xml").withBody(dialJoeRcml)));
