...
public class AccountsEndpointClosingTest extends EndpointTest {
    ...
    public void removeAccountAndSendNotifications() throws InterruptedException {
        ...
        verify(6, postRequestedFor(urlMatching("/restcomm-rvd/services/notifications")).withHeader("Content-Type",
    ...
    public void removeAccountAndReleaseProvidedNumbers() {
        ...
        resource = jersey.resource(getResourceUrl(
                "/2012-04-24/Accounts/" + closedParentSid + "/IncomingPhoneNumbers/PH00000000000000000000000000000002.json"));
