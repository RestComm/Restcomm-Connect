...
public class RestcommConferenceParticipantsTool {
    ...
    private String getAccountsUrl(String deploymentUrl, String username, String conferenceSid, Boolean json) {
        ...
        accountsUrl = deploymentUrl + "/2012-04-24/Accounts/" + username + "/Conferences/" + conferenceSid + "/Participants"
                + ((json) ? ".json" : "");
    ...
    public JsonObject getParticipants(String deploymentUrl, String username, String authToken, String conferenceSid,
            Integer page, Integer pageSize, Boolean json) {
    ...
    public JsonObject getParticipant(String deploymentUrl, String username, String conferenceSid, String authToken,
            String sid) {
    ...
    public JsonObject getParticipantsUsingFilter(String deploymentUrl, String username, String conferenceSid, String authToken,
    ...
    public JsonObject modifyCall(String deploymentUrl, String username, String conferenceSid, String authToken, String callSid,
