...
package org.restcomm.connect.http.link;
...
public class LinkProvider implements HeaderDelegateProvider<Link> {
    ...
    static JerseyLink.Builder initBuilder(JerseyLink.Builder lb, String value) {
        //TODOthrowIllegalArgumentExceptionIfNull(value, LocalizationMessages.LINK_IS_NULL());
        try {
            value = value.trim();
            final String params;
            if (value.startsWith("<")) {
    ...
    static String stringfy(final Link value) {
        //TODO throwIllegalArgumentExceptionIfNull(value, LocalizationMessages.LINK_IS_NULL());
