...
public class RestcommCallsTool {
    ...
    private String getCallRecordingsUrl(String deploymentUrl, String username, String callSid, Boolean json) {
        ...
        String url = deploymentUrl + "/2012-04-24/Accounts/" + username + "/Calls/" + callSid + "/Recordings"
                + ((json) ? ".json" : "");
        return url;
    }
    ...
    /**
     * getCall from another account's resource https://github.com/RestComm/Restcomm-Connect/issues/1939
     *
     * @param deploymentUrl
     * @param username
     * @param authToken
    ...
    public JsonObject getCallsUsingFilter(String deploymentUrl, String username, String authToken,
    ...
    public JsonElement createCall(String deploymentUrl, String username, String authToken, String from, String to,
            String rcmlUrl) {
        return createCall(deploymentUrl, username, authToken, from, to, rcmlUrl, null, null, null, null);
    }

    public JsonElement createCall(String deploymentUrl, String username, String authToken, String from, String to,
            String rcmlUrl, String timeout) {
        return createCall(deploymentUrl, username, authToken, from, to, rcmlUrl, null, null, null, timeout);
    }

    public JsonElement createCall(String deploymentUrl, String username, String authToken, String from, String to,
            String rcmlUrl, final String statusCallback, final String statusCallbackMethod, final String statusCallbackEvent) {
        return createCall(deploymentUrl, username, authToken, from, to, rcmlUrl, statusCallback, statusCallbackMethod,
     ...
     * @throws Exception
     */
    public JsonObject modifyCall(String deploymentUrl, String username, String authToken, String callSid, Boolean mute)
            throws Exception {
