...
/**
 * Base class that hides some of the boilerplate code need to set-up a new automated test. You will need to extend and provide
 * your own 'logger' and createWebArchiveNoGw() method.
 *
