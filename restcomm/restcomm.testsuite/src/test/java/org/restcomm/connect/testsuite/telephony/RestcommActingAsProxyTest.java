...
public class RestcommActingAsProxyTest {
    ...
    public static WebArchive createWebArchiveNoGw() {
        ...
        archive.addAsWebInfResource("restcomm_acting_as_proxy.xml", "conf/restcomm.xml");
    ...
    public void before() throws Exception {
        ...
        otherRestcommPhone = otherRestcommSipStack.createSipPhone("127.0.0.1", SipStack.PROTOCOL_UDP, 5080,
                otherRestcommContact);
    ...
    public void testDialNumberToProxyFromClient() throws ParseException, InterruptedException, MalformedURLException {
        ...
        bobCall.initiateOutgoingCall(bobContact, "sip:+15126008888@127.0.0.1:5080", null, body, "application", "sdp", null,
                null);
        ...
        assertTrue(otherRestcommCall.sendIncomingCallResponse(Response.OK, "George-OK", 3600, receivedBody, "application",
                "sdp", null, null));
        assertTrue(otherRestcommCall.waitForAck(50000));

        assertEquals(2,
                MonitoringServiceTool.getInstance().getStatistics(deploymentUrl.toString(), adminAccountSid, adminAuthToken));
        assertEquals(1, MonitoringServiceTool.getInstance().getLiveIncomingCallStatistics(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken));
        assertEquals(1, MonitoringServiceTool.getInstance().getLiveOutgoingCallStatistics(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken));
        assertEquals(2, MonitoringServiceTool.getInstance().getLiveCallsArraySize(deploymentUrl.toString(), adminAccountSid,
                adminAuthToken));
    ...
    public void testDialNumberToProxyFromNonClient() throws ParseException, InterruptedException, MalformedURLException {
        ...
        henriqueCall.initiateOutgoingCall(henriqueContact, "sip:+15126008888@127.0.0.1:5080", null, body, "application", "sdp",
                null, null);
