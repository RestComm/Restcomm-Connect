...
public class RecordingEndpointTest extends EndpointTest {
    ...
    public void getRecordingListUsingPageSize() {
        ...
        JsonObject lastPage = (JsonObject) RecordingEndpointTool.getInstance().getRecordingList(deploymentUrl.toString(),
    ...
    public void getRecordingListFilteredByStartTime() {
        ...
        JsonObject filteredRecordingsByStartTime = RecordingEndpointTool.getInstance()
                .getRecordingListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getRecordingListFilteredByEndTime() {
        ...
        JsonObject filteredRecordingsByEndTime = RecordingEndpointTool.getInstance()
                .getRecordingListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getRecordingListFilteredByCallSid() {
        ...
        JsonObject filteredRecordingsByCallSid = RecordingEndpointTool.getInstance()
                .getRecordingListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
