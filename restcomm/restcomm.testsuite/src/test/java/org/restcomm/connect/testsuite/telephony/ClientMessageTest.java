...
public class ClientMessageTest {
    ...
    public void before() throws Exception {
        ...
        mariaRestcommClientSid = CreateClientsTool.getInstance().createClient(deploymentUrl.toString(), "maria", "1234qwerT",
                null);
        georgeRestcommClientSid = CreateClientsTool.getInstance().createClient(deploymentUrl.toString(), "george", "1234qwerT",
                null);
        Thread.sleep(500);
    }
