...
public class GatewaysEndpointTest {
    ...
    public void createGatewayTest() throws ClientProtocolException, IOException, ParseException, InterruptedException {
        JsonObject gateway = CreateGatewaysTool.getInstance().createGateway(deploymentUrl.toString(), gwName, gwUsername,
                gwPassword, gwProxy, gwRegister, gwTTL);
    ...
    public void updateGatewayTest() throws ClientProtocolException, IOException, ParseException, InterruptedException {
        ...
        JsonObject updatedGateway = CreateGatewaysTool.getInstance().updateGateway(deploymentUrl.toString(), sid, newName, null,
                null, null, null, null);
