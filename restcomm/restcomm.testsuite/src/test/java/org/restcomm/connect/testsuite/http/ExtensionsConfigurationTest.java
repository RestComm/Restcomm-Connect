...
public class ExtensionsConfigurationTest {
    ...
    public void testCreateAndUpdateJsonConfiguration() throws UnsupportedEncodingException {
        ...
        JsonObject response = RestcommExtensionsConfigurationTool.getInstance().postConfiguration(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken, configurationParams);
        assertNotNull(response);

        JsonObject extension = RestcommExtensionsConfigurationTool.getInstance().getConfiguration(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken, extensionName);
        ...
        JsonObject updatedExtension = RestcommExtensionsConfigurationTool.getInstance().updateConfiguration(
                deploymentUrl.toString(), adminAccountSid, adminAuthToken, extensionSid, updatedConfigurationParams);
    ...
    public void testCreateJsonConfigurationAndGetBySid() throws UnsupportedEncodingException {
        ...
        JsonObject extensionBySid = RestcommExtensionsConfigurationTool.getInstance().getConfiguration(deploymentUrl.toString(),
                adminAccountSid, adminAuthToken, extensionSid);
