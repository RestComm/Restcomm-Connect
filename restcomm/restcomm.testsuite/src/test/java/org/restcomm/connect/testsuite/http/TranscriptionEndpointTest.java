...
public class TranscriptionEndpointTest extends EndpointTest {
    ...
    public void getTranscriptionList() {
        JsonObject firstPage = TranscriptionEndpointTool.getInstance().getTranscriptionList(deploymentUrl.toString(),
    ...
    public void getTranscriptionListUsingPageSize() {
        ...
        JsonObject secondPage = (JsonObject) TranscriptionEndpointTool.getInstance()
                .getTranscriptionList(deploymentUrl.toString(), adminAccountSid, adminAuthToken, 2, 10, true);
        ...
        JsonObject lastPage = (JsonObject) TranscriptionEndpointTool.getInstance().getTranscriptionList(
                deploymentUrl.toString(), adminAccountSid, adminAuthToken, firstPage.get("num_pages").getAsInt(), 10, true);
    ...
    public void getTranscriptionListFilteredByStartTime() {
        ...
        JsonObject filteredTranscriptionsByStartTime = TranscriptionEndpointTool.getInstance()
                .getTranscriptionListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getTranscriptionListFilteredByEndTime() {
        ...
        JsonObject filteredTranscriptionsByEndTime = TranscriptionEndpointTool.getInstance()
                .getTranscriptionListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
    ...
    public void getTranscriptionListFilteredByTranscriptionText() {
        ...
        JsonObject filteredTranscriptionsByTranscriptionText = TranscriptionEndpointTool.getInstance()
                .getTranscriptionListUsingFilter(deploymentUrl.toString(), adminAccountSid, adminAuthToken, filters);
