...
/**
 * Tests whether CORS restrictions are relaxed when <rcmlserver/> configuration contains an absolute baseurl. Currently it only
 * tests Accounts endpoint where CORS-relax logic has been applied
 *
...
public class CorsRelaxTest extends EndpointTest {
    ...
    public void corsHeadersAreReturnedForAccount() {
        ...
        // make a preflight OPTIONS request using an origin NOT present in restcomm.xml/rcmlserver i.e.
        // http://otherhost.restcomm.com
        WebResource resource2 = jersey
                .resource(getResourceUrl("/restcomm/2012-04-24/Accounts.json/ACae6e420f425248d6a26948c17a9e2acf"));
