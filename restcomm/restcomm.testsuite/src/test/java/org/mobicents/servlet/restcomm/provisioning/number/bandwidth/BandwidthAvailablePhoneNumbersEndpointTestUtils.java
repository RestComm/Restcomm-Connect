...
public class BandwidthAvailablePhoneNumbersEndpointTestUtils {
    ...
    public static String validTollFreeSearchResult = "<SearchResult><ResultCount>2</ResultCount><TelephoneNumberList><TelephoneNumber>8885551212</TelephoneNumber><TelephoneNumber>8885551213</TelephoneNumber></TelephoneNumberList></SearchResult>";
    public static String validTollFreeJsonResult = "{\"friendlyName\":\"+18885551212\",\"phoneNumber\":\"+18885551212\",\"isoCountry\":\"US\",\"voiceCapable\":true,\"smsCapable\":true,\"mmsCapable\":false,\"faxCapable\":false,\"ussdCapable\":false}";
    public static String invalidTollFreeSearchResult = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><SearchResult><Error><Code>4004</Code><Description>TollFree wild character search must start with an 8</Description></Error></SearchResult>";
}
