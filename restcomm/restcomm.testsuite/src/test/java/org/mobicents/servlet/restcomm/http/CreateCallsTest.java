...
public class CreateCallsTest {
	...
	//This RCML will dial +131313 which George's phone is listening (use the dial-number-entry.xml as a side effect to verify that the call created successfully) 
	...
	@Test
	//Create a call to a Restcomm Client. Non-regression test for issue https://bitbucket.org/telestax/telscale-restcomm/issue/175
	...
	//This RCML will dial Alice Restcomm client (use the dial-number-entry.xml as a side effect to verify that the call created successfully)
	public void createCallNumberTest() throws InterruptedException, ParseException {
		...
		String from = "+15126002188";
		String to = "131313";
		String rcmlUrl = "http://127.0.0.1:8080/restcomm.application-6.1.2-TelScale-SNAPSHOT/dial-client-entry.xml";
