 ...
 */
public final class AWSPollySpeechSyntetizerTest {
    private ActorSystem system;
    private ActorRef tts;
    private ActorRef cache;
    private String tempSystemDirectory;

    public AWSPollySpeechSyntetizerTest() throws ConfigurationException {
        super();
    }
    ...
    public void before() throws Exception {
        ...
        final URL input = getClass().getResource("/awspolly.xml");
        ...
        new JavaTestKit(system) {
            {
                ...
                final SpeechSynthesizerResponse<SpeechSynthesizerInfo> response = this
                        .expectMsgClass(FiniteDuration.create(30, TimeUnit.SECONDS), SpeechSynthesizerResponse.class);
