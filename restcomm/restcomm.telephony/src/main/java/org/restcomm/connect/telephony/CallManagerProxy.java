...
public final class CallManagerProxy extends SipServlet implements SipServletListener {
    ...
    private ActorRef manager(final Configuration configuration, final ServletContext context,
        ...
        final Props props = new Props(new UntypedActorFactory() {
            ...
            public UntypedActor create() throws Exception {
                return new CallManager(configuration, context, msControllerfactory, conferences, bridges, sms, factory,
                        storage);
            }
        });
    ...
    private ActorRef ussdManager(final Configuration configuration, final ServletContext context, final SipFactory factory,
    ...
    public void servletInitialized(SipServletContextEvent event) {
        if (event.getSipServlet().getClass().equals(CallManagerProxy.class)) {
            ...
            sendTryingForInitalRequests = Boolean.parseBoolean(
                    configuration.subset("runtime-settings").getString("send-trying-for-initial-requests", "false"));
