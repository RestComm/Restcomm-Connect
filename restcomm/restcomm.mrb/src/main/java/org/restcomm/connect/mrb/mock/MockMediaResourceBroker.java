...
public class MockMediaResourceBroker extends MediaResourceBrokerGeneric {
    ...
    public void onReceive(Object message) throws Exception {
        ...
        if (StartMediaResourceBroker.class.equals(klass)) {
            ...
            /*
             * }catch(Exception e){ logger.error("MockMediaResourceBroker onReceive: {}", e); }finally{ sender.tell(message,
             * self); }
             */
        }
    }
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.connect.telscale.mrb.MediaResourceBroker#onStartMediaResourceBroker(org.restcomm.connect.mrb.api.
     * StartMediaResourceBroker, akka.actor.ActorRef, akka.actor.ActorRef)
     */
    @Override
