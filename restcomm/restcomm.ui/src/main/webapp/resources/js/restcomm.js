...
rcMod.
  factory('authHttpResponseInterceptor',['$q','$location','$injector','IdentityConfig','Notifications','SessionService',function($q,$location,$injector,IdentityConfig, Notifications, SessionService){
    return {
      request: function(config) {
