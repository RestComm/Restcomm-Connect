...
public final class DiskCacheResponse extends StandardResponse<URI> {
    ...
    public String toString() {
        ...
        return (new StringBuffer("DiskCacheResponse [succeeded=").append(succeeded()).append(", cause=")
                .append(cause().getMessage()).append(", message=").append(error()).append(", object=").append(get())
                .append("]")).toString();
    }
}
