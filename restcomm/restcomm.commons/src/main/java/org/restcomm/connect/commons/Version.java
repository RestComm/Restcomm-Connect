...
public class Version {
    ...
    public static void printVersion() {
        if (logger.isInfoEnabled()) {
            ...
            if (releaseVersion != null) {
                ...
                logger.info("Release ID: Restcomm-Connect " + releaseVersion + " (build: Git Hash=" + releaseRevision + " date="
                        + releaseDate + ")");
                logger.info(releaseName + " Restcomm-Connect " + releaseVersion + " (build: Git Hash=" + releaseRevision
                        + " date=" + releaseDate + ") Started.");
            } else {
    ...
    private static VersionEntity generateVersionEntity() {
        ...
        try {
            InputStream in = Version.class.getResourceAsStream("release.properties");
            if (in != null) {
    ...
    public static String getFullVersion() {
        ...
        return "Release ID: Restcomm-Connect " + releaseVersion + " (build: Git Hash=" + releaseRevision + " date="
                + releaseDate + ")";
    }
