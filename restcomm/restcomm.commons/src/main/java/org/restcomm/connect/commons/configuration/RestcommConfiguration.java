...
/**
 * Singleton like class that provides access to ConfigurationSets. Use get+() functions to access configuration sets.
 *
...
public class RestcommConfiguration {
    ...
    /*
     * public void reloadMain() { MainConfigurationSet oldMain = getMain(); MainConfigurationSet newMain = new
     * MainConfigurationSet(oldMain.getSource()); sets.put("main", newMain); }
     */
    ...
    public RcmlserverConfigurationSet getRcmlserver() {
        return (RcmlserverConfigurationSet) sets.get("rcmlserver");
    }
