...
public abstract class StandardResponse<T> {
    ...
    public String toString() {
        return (new StringBuffer("StandardResponse [succeeded=").append(succeeded).append(", cause=")
                .append(cause).append(", message=").append(message).append(", object=").append(object).append("]")).toString();
    }
}
