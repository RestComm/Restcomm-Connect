 ...
 *
 */
public abstract class ConfigurationSetImpl implements ConfigurationSet {
    protected final ConfigurationSource source;
    protected List<ConfigurationUpdateListener> updateListeners;

    protected ConfigurationSetImpl(ConfigurationSource source, List<ConfigurationUpdateListener> listeners) {
        super();
        this.source = source;
        if (listeners != null)
    ...
    protected ConfigurationSetImpl(ConfigurationSource source) {
        this(source, null);
    }
