        ...
        new JavaTestKit(system) {
            {
                ...
                final URI uri = URI.create(
                        "http://127.0.0.1:8080/restcomm/cache/0877edd3c836d7b38d9615939ff66254fab90b868d75e1b86fcc8d42682d9741.html");
        ...
        new JavaTestKit(system) {
            {
                ...
                final URI result = response.get();
                final URI uri = URI.create(
                        "http://127.0.0.1:8080/restcomm/cache/c32735f2960ef70edb5116e8459c5b65915b3c27ea4773feaa35ce55220f4755.html");
                assertTrue(result.equals(uri));
            }
        };
    }
