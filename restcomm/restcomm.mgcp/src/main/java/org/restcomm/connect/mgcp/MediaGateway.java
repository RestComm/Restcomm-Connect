...
public final class MediaGateway extends RestcommUntypedActor implements JainMgcpListener {
    ...
    private MediaSession getSession() {
        ...
        try {
            ...
            logger.error("Exception in getSession: " + e.getMessage() + " is MediaGateway actor terminated? "
                    + self().isTerminated() + " current object snapshot: \n" + this.toString(), e);
        }
        return s;
    }
    ...
    public void onReceive(final Object message) throws Exception {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("MediaGateway onReceive. self.isTerminated: " + self.isTerminated() + " | Processing "
                    + klass.getName() + " | object snapshot: \n" + this.toString());
        }
        ...
        if (PowerOnMediaGateway.class.equals(klass)) {
            ...
            if (logger.isInfoEnabled())
                logger.info("Gateway: " + self().path() + " about to stop endpoint path: " + request.endpoint().path()
                        + " isTerminated: " + request.endpoint().isTerminated() + " sender: " + sender().path());
    ...
    public String toString() {
        return "MediaGateway [logger=" + logger + ", name=" + name + ", localIp=" + localIp + ", localPort=" + localPort
                + ", remoteIp=" + remoteIp + ", remotePort=" + remotePort + ", useNat=" + useNat + ", externalIp=" + externalIp
                + ", timeout=" + timeout + ", provider=" + provider + ", stack=" + stack + ", agent=" + agent + ", domain="
                + domain + ", notificationListeners=" + notificationListeners + ", responseListeners=" + responseListeners
                + ", requestIdPool=" + requestIdPool + ", sessionIdPool=" + sessionIdPool + ", transactionIdPool="
                + transactionIdPool + "]";
    }
