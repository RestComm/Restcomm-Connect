...
public final class PowerOnMediaGateway {
    ...
    public PowerOnMediaGateway(final String name, final InetAddress localIp, final int localPort, final InetAddress remoteIp,
            ...
            final JainMgcpStack stack, final JainMgcpProvider provider) {
        super();
        this.name = name;
    ...
    public static final class Builder {
        ...
        public PowerOnMediaGateway build() {
            return new PowerOnMediaGateway(name, localIp, localPort, remoteIp, remotePort, useNat, externalIp, timeout, stack,
                    provider);
        }
