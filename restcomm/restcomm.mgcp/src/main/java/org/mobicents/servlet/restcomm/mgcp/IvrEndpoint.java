...
public final class IvrEndpoint extends GenericEndpoint {
  ...
  public IvrEndpoint(final ActorRef gateway, final MediaSession session,
  ...
  @Override public void onReceive(final Object message) throws Exception {
    ...
    if(Observe.class.equals(klass)) {
      ...
      id = request.id();
    } else if(Play.class.equals(klass) || PlayCollect.class.equals(klass) ||
        PlayRecord.class.equals(klass)) {
      send(message);
