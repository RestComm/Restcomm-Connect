...
@Immutable public final class PlayCollect extends AbstractMgcpAUMessage {
  ...
  private PlayCollect(final List<URI> initialPrompts, final boolean clearDigitBuffer,
      final int maxNumberOfDigits, final int minNumberOfDigits, final String digitPattern,
  ...
  public static final class Builder {
    ...
    public PlayCollect build() {
      return new PlayCollect(initialPrompts, clearDigitBuffer, maxNumberOfDigits,
          minNumberOfDigits, digitPattern, firstDigitTimer, interDigitTimer, endInputKey);
    }
