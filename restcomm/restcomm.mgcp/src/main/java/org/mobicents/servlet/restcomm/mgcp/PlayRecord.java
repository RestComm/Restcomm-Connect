...
@Immutable public final class PlayRecord {
  ...
  private PlayRecord(final List<URI> initialPrompts, final boolean clearDigitBuffer,
      final long preSpeechTimer, final long postSpeechTimer, final long recordingLength,
      final String endInputKey, final URI recordingId) {
    super();
  ...
  public static final class Builder {
    ...
    public PlayRecord build() {
      return new PlayRecord(initialPrompts, clearDigitBuffer, preSpeechTimer,
          postSpeechTimer, recordingLength, endInputKey, recordingId);
    }
