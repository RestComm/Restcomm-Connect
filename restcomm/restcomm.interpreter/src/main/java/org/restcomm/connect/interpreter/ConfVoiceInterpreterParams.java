...
public final class ConfVoiceInterpreterParams {
    ...
    private ConfVoiceInterpreterParams(Configuration configuration, Sid account, String version, URI url, String method,
            String emailAddress, ActorRef conference, DaoManager storage, CallInfo callInfo) {
    ...
    public static class ConfVoiceInterpreterParamsBuilder {
        ...
        public ConfVoiceInterpreterParams biuld() {
            return new ConfVoiceInterpreterParams(configuration, account, version, url, method, emailAddress, conference,
                    storage, callInfo);
        }
    }
}
