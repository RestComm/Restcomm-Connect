...
public final class GeolocationInterpreterBuilder {
    ...
    public GeolocationInterpreterBuilder(final ActorSystem system) {
        super();
        this.system = system;
    }
    ...
    public ActorRef build() {
        return system.actorOf(new Props(new UntypedActorFactory() {
            ...
            public UntypedActor create() throws Exception {
                return new GeolocationInterpreter(service, configuration, storage, accountId, version, url, method, fallbackUrl,
                        fallbackMethod);
            }
        }));
    }
    ...
    public void setGeolocationService(final ActorRef service) {
