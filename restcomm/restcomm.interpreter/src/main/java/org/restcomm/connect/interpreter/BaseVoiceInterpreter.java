...
public abstract class BaseVoiceInterpreter extends RestcommUntypedActor {
    ...
    // Callback using the Akka ask pattern
    // (http://doc.akka.io/docs/akka/2.2.5/java/untyped-actors.html#Ask__Send-And-Receive-Future) will force VoiceInterpter to
    // wait until
    ...
    final class HangingUp extends AbstractAction {
        ...
        public void execute(final Object message) throws Exception {
            ...
            if (ParserFailed.class.equals(klass)) {
                ...
                Integer sipResponse = outboundCallResponse != null ? outboundCallResponse
