...
public final class CallApiResponse extends StandardResponse<HttpResponseDescriptor> {
    public CallApiResponse(final HttpResponseDescriptor object) {
        super(object);
    }

    public CallApiResponse(final Throwable cause) {
        super(cause);
    }

    public CallApiResponse(final Throwable cause, final String message) {
        super(cause, message);
    }
}
