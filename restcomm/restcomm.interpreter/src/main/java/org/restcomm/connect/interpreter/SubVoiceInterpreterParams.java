...
public final class SubVoiceInterpreterParams {
    ...
    private SubVoiceInterpreterParams(Configuration configuration, DaoManager storage, ActorRef callManager,
            ActorRef conferenceCenter, ActorRef smsService, Sid account, Sid phone, String version, URI url, String method,
            URI fallbackUrl, String fallbackMethod, URI statusCallback, String statusCallbackMethod, String emailAddress,
            Boolean hangupOnEnd) {
    ...
    public static final class Builder {
        ...
        public SubVoiceInterpreterParams build() {
            return new SubVoiceInterpreterParams(configuration, storage, callManager, conferenceCenter, smsService, account,
                    phone, version, url, method, fallbackUrl, fallbackMethod, statusCallback, statusCallbackMethod,
                    emailAddress, hangupOnEnd);
        }
    }
}
