 ...
 */
public final class CallInterpreter extends UntypedActor {
  ...
  private final State initializingInterpreter;
  private final State initializingInterpreterFallback;
  ...
  */
  ...
  public CallInterpreter(final Configuration configuration, final Sid account, final Sid phone,
    ...
    initializingInterpreter = new State("initializing interpreter",
        new InitializingInterpreter(source), null);
    initializingInterpreterFallback = new State("initializing interpreter fallback",
        new InitializingInterpreterFallback(source), null);
  ...
  private final class InitializingInterpreter extends AbstractAction {
    public InitializingInterpreter(final ActorRef source) {
      super(source);
    }
  ...
  private final class InitializingInterpreterFallback extends AbstractAction {
    public InitializingInterpreterFallback(final ActorRef source) {
      super(source);
    }
  ...
  private final class Ready extends AbstractAction {
	...
	@Override public void execute(final Object message) throws Exception {
	  ...
	  final UntypedActorContext context = getContext();
	  final State state = fsm.state();
	  if(initializingInterpreter.equals(state) ||
	      initializingInterpreterFallback.equals(state) ||
