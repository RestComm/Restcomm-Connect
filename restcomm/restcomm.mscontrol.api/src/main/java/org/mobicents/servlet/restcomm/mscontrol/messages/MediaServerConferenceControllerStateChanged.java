...
public final class MediaServerConferenceControllerStateChanged extends MediaServerControllerStateChanged {
    ...
    public MediaServerConferenceControllerStateChanged(final MediaServerControllerState state, MediaSessionInfo mediaSession,
            final Sid conferenceSid, final String conferenceState, final boolean moderatorPresent) {
    ...
    public MediaServerConferenceControllerStateChanged(final MediaServerControllerState state, final Sid conferenceSid,
            final String conferenceState) {
        this(state, null, conferenceSid, conferenceState, false);
    }

    public MediaServerConferenceControllerStateChanged(final MediaServerControllerState state, final Sid conferenceSid,
            final String conferenceState, final boolean moderatorPresent) {
