 ...
 */
public final class IPSMServiceProxy extends SipServlet {
  private static final long serialVersionUID = 1L;
  
  private ActorSystem system;
  private ActorRef service;

  public IPSMServiceProxy() {
    super();
  }
  ...
  @Override public void init(final ServletConfig config) throws ServletException {
    ...
    service = service(config, factory, storage, endpoint);
  }
