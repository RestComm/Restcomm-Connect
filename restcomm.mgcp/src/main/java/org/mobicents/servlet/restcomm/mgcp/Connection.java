...
public final class Connection extends UntypedActor {
  ...
  public Connection(final ActorRef gateway, final MediaSession session, final NotifiedEntity agent,
    final long timeout) {
    super();
    ...
    initializing = new State("initializing", new EnteringInitialization(source),
        new ExitingInitialization(source));
