...
public final class TwiMLInterpreterContext {
  private final Call call;
  
  public TwiMLInterpreterContext(final Call call) {
    super();
    this.call = call;
  }
  
  private Application getApplication() throws TwiMLInterpreterContextException {
    ...
    try {
	  ...
	  throw new TwiMLInterpreterContextException(exception);
	}
  }
  ...
  public ResourceDescriptor getEntryPointDescriptor() throws TwiMLInterpreterContextException {
